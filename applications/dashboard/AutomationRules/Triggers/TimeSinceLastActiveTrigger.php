...
/**
 * @copyright 2009-2024=5 Vanilla Forums Inc.
 * @license Proprietary
 */
...
/**
 * Class TimeSinceLastActiveTrigger
 */
class TimeSinceLastActiveTrigger extends TimedAutomationTrigger
{
    /**
     * @inheritdoc
     */
    ...
    {
        return "timeSinceLastActiveTrigger";
    }
    ...
    {
        return [AddRemoveUserRoleAction::class];
    }
