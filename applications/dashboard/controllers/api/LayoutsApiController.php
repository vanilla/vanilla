...
class LayoutsApiController extends \AbstractApiController
{
    ...
    public function put_viewsLegacy(array $body): Data
    {
        ...
        if ($layoutViewType === \CategoryModel::LAYOUT_CATEGORY_LIST) {
            // Delete the active layouts.
            $this->layoutViewModel->delete([
                "layoutViewType" => [
                    \CategoryModel::LAYOUT_CATEGORY_LIST,
                    \CategoryModel::LAYOUT_NESTED_CATEGORY_LIST,
                    \CategoryModel::LAYOUT_DISCUSSION_CATEGORY_PAGE,
                ],
            ]);
        } else {
            // Delete the active layouts.
        ...
        switch ($layoutViewType) {
            case "home":
                $this->config->saveToConfig([
                    ...
                    "Feature.customLayout.subcommunityHome.Enabled" => false,
                ]);
                break;
            case "discussionList":
                $this->config->saveToConfig([
            ...
            case "categoryList":
                $this->config->saveToConfig([
                    ...
                    "Feature.customLayout.nestedCategoryList.Enabled" => false,
                    "Feature.customLayout.discussionCategoryPage.Enabled" => false,
                ]);
                break;
            default:
                $this->config->saveToConfig([
