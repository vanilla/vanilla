...
class ProfileController extends Gdn_Controller {
    ...
    public function activity($UserReference = '', $Username = '', $UserID = '', $Page = '') {
        ...
        // Set user, tab, and comment
        $this->setUserInfo($UserReference, $Username, $UserID, false, false);
    ...
    public function connect($Type, $UserReference = '', $Username = '') {
        ...
        $this->setUserInfo($UserReference, $Username, '', true);
    ...
    public function edit($UserReference = '', $Username = '', $UserID = '') {
        $this->permission('Garden.SignIn.Allow');
        $this->setUserInfo($UserReference, $Username, $UserID, true);
        $UserID = valr('User.UserID', $this);
        $Settings = array();
    ...
    public function index($User = '', $Username = '', $UserID = '', $Page = false) {
        $this->setUserInfo($User, $Username, $UserID, false, false);
    ...
    public function invitations($UserReference = '', $Username = '', $UserID = '') {
        $this->permission('Garden.SignIn.Allow');
        $this->setUserInfo($UserReference, $Username, $UserID, $this->Form->authenticatedPostBack(), false);
...
//              $this->addJsFile('jquery.gardenmorepager.js');
     ...
     * @return bool Always true.
     * @deprecated since 2.3. Use setUserInfo instead.
     */
    public function getUserInfo($UserReference = '', $Username = '', $UserID = '', $CheckPermissions = false) {
        $this->setUserInfo($UserReference, $Username, $UserID, $CheckPermissions);
    }

    /**
     * Load info of the user to be handled in the profile. Defaults to session user.
     * Replacement for getUserInfo()
     *
     * Events: UserLoaded
     *
     * @since 2.3
     ...
     * @param int $userID Unique ID.
     * @param bool $checkPermissions Whether or not to check user permissions.
     * @param bool $editMode Whether to show edit or "normal" side menu.
     * @return bool Always true.
     */
    public function setUserInfo($userReference = '', $username = '', $userID = '', $checkPermissions = false, $editMode = true) {
