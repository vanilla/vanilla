...
$Definition["ValidateConnection"] =
    "The connection parameters you specified failed to open a connection to the database. The database reported the following error: <code>%s</code>";
//$Definition['ValidateMinimumAge'] = 'You are too young to proceed.';
$Definition["ValidateMatch"] = "The %s fields do not match.";
$Definition["ValidateStrength"] =
    "The supplied %s is too weak. Try using a stronger password and use the strength meter as a guide.";
$Definition["ValidateVersion"] =
    "The %s field is not a valid version number. See the php version_compare() function for examples of valid version numbers.";
...
$Definition["Garden.api.ssoIDPermission.description"] =
    "Roles with this permission will be able to expand SSO IDs in API v2 calls.";
...
$Definition[
    "EmailPassword"
] = '%2$s has reset your password at %3$s for your login with email address %6$s. Please contact them if you do not know the new password.

  Url: %4$s';
$Definition["EmailConfirmEmail"] =
    "You need to confirm your email address before you can continue. Please confirm your email address by clicking on the following link: {/entry/emailconfirm,exurl,domain}/{User.UserID,rawurlencode}/{EmailKey,rawurlencode}";
$Definition[
    "PasswordRequest"
...
Have a great day!';
$Definition["HeadlineFormat.Discussion"] =
    '{ActivityUserID,user} Started a new discussion. <a href="{Url,html}">{Data.Name,text}</a>';
$Definition["HeadlineFormat.Discussion.Poll"] =
    '{ActivityUserID,user} started a new poll in {Data.Category}: <a href="{Url,html}">{Data.Name,text}</a>';
$Definition["HeadlineFormat.Discussion.Question"] =
    '{ActivityUserID,user} posted a new question in {Data.Category}: <a href="{Url,html}">{Data.Name,text}</a>';
...
$Definition["PluginHelp"] =
    "Plugins allow you to add functionality to your site.<br />Once a plugin has been added to your %s folder, you can enable or disable it here.";
$Definition["ApplicationHelp"] =
    "Applications allow you to add large groups of functionality to your site.<br />Once an application has been added to your %s folder, you can enable or disable it here.";
...
$Definition["Warning: This is for advanced users."] =
    "<b>Warning</b>: This is for advanced users and requires that you make additional changes to your web server. This is usually only available if you have dedicated or vps hosting. Do not attempt this if you do not know what you are doing.";
...
$Definition["Large images will be scaled down."] =
    "Large images will be scaled down to a max width of %spx and a max height of %spx.";
...
$Definition["oauth2Instructions"] =
    "<p>Configure your forum to connect with an OAuth2 application by putting your unique Client ID, Client Secret, and required endpoints. You will probably need to provide your SSO application with an allowed callback URL, in part, to validate requests. The callback url for this forum is <code>%s</code></p>";
