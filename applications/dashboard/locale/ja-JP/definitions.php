...
$Definition['All Conversations'] = 'すべてのプライベートメッセージ';
...
$Definition['Messages can appear anywhere in your application.'] = 'メッセージはサイトのどこにでも表示でき、ユーザーにニュースやイベントを通知するために使われます。このページでメッセージをドラッグすると、順番を入れ替えることができます(Version 2.0.17.8 では入れ替え未実装)。';
...
$Definition['New conversations in the last day'] = '過去一日間の新規プライベートメッセージ (グループ) 数';
$Definition['New conversations in the last week'] = '過去一週間の新規プライベートメッセージ (グループ) 数';
...
$Definition['Spam'] = 'スパム';
$Definition['Start Conversation'] = 'プライベートメッセージを作成する';
...
// Theme - EmbedFriendly
$Definition['This theme allows you to hide the side panel next to your forum and conversations. This is super handy if the website you are embedding in does not have a lot of width to squeeze into.'] = 'このテーマはフォーラムとプライベートメッセージからサイドパネルを隠すことができます。もしフォーラムを埋め込んだウェブサイトがあまり横幅を広くとれないデザインの場合は、これが役に立つことでしょう。';
