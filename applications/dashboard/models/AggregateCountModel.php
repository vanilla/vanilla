...
class AggregateCountModel implements SystemCallableInterface
{
    ...
    public function processAggregateOption($option, ?int $limit = null): Generator
    {
        ...
        try {
            ...
            yield new LongRunnerQuantityTotal($option->getCountBatches());
     ...
     * @param int $limit
     */
    private function calculateBatches(AggregateCountOption $option, int $limit)
    {
