...
class ExternalIssueService
{
    ...
    {
        $this->providers[$provider->getSourceName()] = $provider;
    }
     ...
     */
    public function getProvider(string $sourceName): ExternalIssueProviderInterface
    {
        return $this->providers[$sourceName];
    }
}
