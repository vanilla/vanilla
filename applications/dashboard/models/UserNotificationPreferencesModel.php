...
class UserNotificationPreferencesModel
{
    ...
    public function save(int $userID, array $userPrefs): array
    {
        ...
        if (array_key_exists("Email.DigestEnabled", $prefsToSave)) {
            $action =
                $prefsToSave["Email.DigestEnabled"] == 0
                    ? SubscriptionEvent::ACTION_DIGEST_DISABLED
                    : SubscriptionEvent::ACTION_DIGEST_ENABLED;
            ...
            $digestSubscriptionEvent = new SubscriptionEvent(
                $action,
                [
                    "subscription" => [
                        "type" => $action,
            ...
            $this->eventManager->dispatch($digestSubscriptionEvent);
        }
