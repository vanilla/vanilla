                ...
                foreach ($items as $groupName => $links) {
                    ...
                    foreach ($links as $key => $link) {
                        ...
                        $showLink =
                            ...
                            Gdn::session()->checkPermission($requiredPermissions, false);
                        ...
                        if ($showLink === true) {
                            ...
                            if ($url !== false) {
                                $url = url(
                                    str_replace(
                                        ["{Username}", "{UserID}", "{Session_TransientKey}"],
                                        [urlencode($username), $userID, $session_TransientKey],
                                        $link["Url"]
                                    )
                                );
