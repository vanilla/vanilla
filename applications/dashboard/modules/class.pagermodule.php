...
class PagerModule extends Gdn_Module
{
    ...
    public function toString($type = "more", $attributes = [])
    {
        ...
        if ($pager === "") {
            ...
            $attributes = [
                ...
                "class" => concatSep(" ", $this->CssClass, "PagerLinkCount-" . $linkCount, static::NUMBERED_CLASS),
            ];
            return sprintf($this->Wrapper, attribute($attributes), $pager);
        }
    }
    ...
    public function toStringPrevNext($type = "more", $attributes = [])
    {
        ...
        return $pager == ""
            ...
            : sprintf(
                ...
                attribute([
                    "id" => $clientID,
                    "class" => concatSep(" ", $this->CssClass, static::PREV_NEXT_CLASS),
                    ["tabindex" => "0"],
                ]),
                $pager
            );
    ...
    public static function write($options = [])
    {
        ...
        $pager->CurrentRecords = val(
            "CurrentRecords",
            $options,
            $pager->controller()->data("_CurrentRecords", $pager->CurrentRecords)
        );
        ...
        if (!$pager->Offset) {
            ...
            [$offset, $limit] = offsetLimit($page, $pager->Limit);
    ...
    private function nextLink($currentPage, $linkLabel, $extraAttributes = []): string
    {
        ...
        return anchor($linkLabel, $this->pageUrl($currentPage + 1), "Next", $attr);
    }
    ...
    private function previousLink($currentPage, $linkLabel, $extraAttributes = []): string
    {
        ...
        return anchor($linkLabel, $this->pageUrl($currentPage - 1), "Previous", $attr);
    }
}
