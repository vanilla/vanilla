...
class DashboardHooks extends Gdn_Plugin {
    ...
    public function dashboardNavModule_init_handler($sender) {
        ...
        $nav->addGroupToSection('Moderation', t('Site'), 'site')
            ...
            ->addLinkIf($session->checkPermission(['Garden.Settings.Manage', 'Garden.Community.Manage'], false), t('Branding & SEO'), '/dashboard/settings/branding', 'appearance.banner', '', $sort)
