...
import { getDefaultSiteSection, getMeta, getRelativeUrl, hasMultipleSiteSections, t } from "@library/utility/appUtils";
...
function useLayoutEditorNavTree(ownID: RecordID, parentID: RecordID): INavigationTreeItem {
    ...
    const siteHomeItem: INavigationTreeItem = {
        name: t(`Site Home`),
        parentID: "home",
        recordID: "siteHome",
    ...
    const subcommunityHome: INavigationTreeItem = {
        name: t(`Subcommunity Home`),
        parentID: "home",
    ...
    const navigationItems: INavigationTreeItem[] = [
        ...
        // Only show if it's enabled.
        ...[
            getMeta("featureFlags.layoutEditor.discussionThread.Enabled", false)
                ? {
                      ...
                      children: [
                          ...
                          ...getChildLayouts("discussionThread", "discussionThread"),
                      ],
                  }
                : null,
        ].filter(notEmpty),
