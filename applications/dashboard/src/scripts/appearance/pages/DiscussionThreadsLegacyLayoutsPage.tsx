...
/**
 * TODO: This entire page needs further UX consideration
 */
...
function DiscussionThreadsLegacyLayoutsPage() {
    const configs = useConfigsByKeys(["discussionThread.layout", "customLayout.discussionThread"]);

    const isCustomDiscussionList = configs.data?.["customLayout.discussionThread"] ?? false;

    const legacyPatcher = useLegacyLayoutView("discussionThread", "discussionThread.layout");
            ...
            options={[
                {
                    ...
                    active:
                        !isCustomDiscussionList && configs.data["discussionThread.layout"] == LayoutOption.FOUNDATION,
                    editUrl,
                },
            ]}
        />
...
export default function Page() {
    ...
    return (
        <AdminLayout
            ...
            customTitleBar={
                <AdminTitleBar
                    title={t("Legacy Layouts - Discussion Threads")}
                    description={
                        <Translate
                            source={
                                "Choose the preferred layout for lists of discussion threads. You can edit the Foundation Layout. To learn more, see <0/>."
                            }
                            c0={
            ...
            content={<DiscussionThreadsLegacyLayoutsPage />}
        />
    );
}
