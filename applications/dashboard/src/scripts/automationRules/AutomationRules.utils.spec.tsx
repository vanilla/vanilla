...
describe("Automation Rules Utility Functions", () => {
    function assertTriggerActionSchema(result: any, mode: string) {
        switch (mode) {
            case "emptySelectionSchema":
                expect(Object.keys(result.properties)).toEqual(["trigger", "action"]);
                expect(result.properties.trigger.properties.triggerType.enum.length).toBe(7);
                expect(result.properties.action.properties.actionType.enum.length).toBe(10);
    ...
    it("getTriggerActionFormSchema()", () => {
        ...
        assertTriggerActionSchema(emptySelectionSchema, "emptySelectionSchema");
