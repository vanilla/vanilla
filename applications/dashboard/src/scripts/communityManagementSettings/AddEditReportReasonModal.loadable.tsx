...
import { useReasonsPostPatch } from "@dashboard/moderation/CommunityManagement.hooks";
    ...
    properties: {
        ...
        roleIDs: {
            ...
            "x-control": {
                ...
                multiple: true,
                tooltip:
                    "If no roles are specified, all roles with the `flag.add` permission for a given category can see this reason. Users with `community.manage` permission can use every reason all the time.",
            },
        },
    },
...
export default function AddEditReportReasonModalImp(props: IProps) {
    ...
    const reasonMutation = useReasonsPostPatch(true);
