...
import { useReasonsDelete, useReportReasons } from "@dashboard/moderation/CommunityManagement.hooks";
import { IReason } from "@dashboard/moderation/CommunityManagementTypes";
import { IRole, IRoleFragment } from "@dashboard/roles/roleTypes";
...
export function ReportReasonList(props: IProps) {
    ...
    const deleteReason = useReasonsDelete();
