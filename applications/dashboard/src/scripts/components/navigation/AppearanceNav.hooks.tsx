                ...
                const inactiveCheck = (
                    <span className={classes.iconGroup}>
                        ...
                        <ToolTip label="This applied layout is applied but not active because legacy layouts are enabled.">
                            <ToolTipIcon>
                                <Icon icon="info" className={classes.icon} />
                            </ToolTipIcon>
                        </ToolTip>
                    </span>
                );
...
export function useAppearanceNavItems(parentID: RecordID): INavigationTreeItem[] {
    ...
    const manageIcons: INavigationTreeItem = {
        name: t("Manage Icons"),
        parentID: 0,
        sort: 0,
        recordID: "manageIcons",
        recordType: "customLink",
        children: [],
    ...
    const customPages: INavigationTreeItem = {
        name: t("Custom Pages"),
        parentID: 0,
        sort: 0,
        recordID: "manageCustomPages",
        recordType: "customLink",
        children: [],
        url: getRelativeUrl(CustomPagesRoute.url(undefined)),
    };
    ...
    const brandingAndAssetsTreeItem = {
        ...
        children: [
            brandingPageLink,
            manageIcons,
            ...(fragmentEditorEnabled ? [fragmentEditor] : []),
            customPages,
            ...otherNavItems,
        ]
            .flat()
