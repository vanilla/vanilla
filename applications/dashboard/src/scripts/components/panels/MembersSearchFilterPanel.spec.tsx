...
describe("MembersSearchFilterPanel", () => {
    test("Render filter form without email field because user does not have permission.", async () => {
    ...
    test("Render filter form with email field because user has permission.", async () => {
        render(
    ...
    test("Clear filter values", async () => {
        render(<MockSearchFilterPanel />);
