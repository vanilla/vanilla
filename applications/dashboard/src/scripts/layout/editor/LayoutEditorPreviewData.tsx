...
export class LayoutEditorPreviewData {
     ...
     */
    public static subcommunities(): IHomeWidgetItemProps[] {
        return [
            {
     ...
     */
    public static categories(itemsNumber: number = 6): IHomeWidgetItemProps[] {
    ...
    public static discussions(count = 3, includeUnread?: boolean): IDiscussion[] {
        const fakeDiscussions: IDiscussion[] = [
            ...
            },
            {
                ...
                countViews: 999,
                countComments: 9999,
                categoryID: 3333333333333333333,
                category: {
                    name: "Category 3",
                    url: "#",
                    categoryID: 3333333333333333333,
                },
                tags: [{ tagID: 111111111111111111, name: "User Tag", urlcode: "#" }],
            },
        ];
