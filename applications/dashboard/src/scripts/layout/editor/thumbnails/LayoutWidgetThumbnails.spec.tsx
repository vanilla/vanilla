...
const renderInProvider = (element) => {
    const configHashKey = stableObjectHash([CONFIG_FEATURED_COLLECTIONS]);
    const tmpState = {
        config: {
            configsByLookupKey: {
                [configHashKey]: {
                    ...
                    data: {
                        [CONFIG_FEATURED_COLLECTIONS]: false,
                    },
                },
            },
        },
    ...
    return render(LayoutEditorFixture.createMockLayoutsProvider(element, tmpState));
};
