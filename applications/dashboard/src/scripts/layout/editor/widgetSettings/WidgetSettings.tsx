...
export function WidgetSettings(props: IWidgetConfigurationComponentProps) {
    ...
    const transformedSchema = widgetsSchemaTransformer(props.schema, props.middlewares);
    ...
    return (
        <div className={classes.settings}>
            ...
            <JsonSchemaForm
                ...
                FormControl={(props) => DashboardFormControl(props, [QUICK_LINKS_LIST_AS_MODAL])}
