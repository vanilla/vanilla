...
export function WidgetSettingsModal(props: IProps) {
    const { widgetID, onSave, isVisible, exitHandler, initialValue, widgetCatalog, middlewaresCatalog } = props;
                ...
                <Frame
                    header={
                        <FrameHeader
                            ...
                            title={`${t("Add/Edit")} ${widgetCatalog[widgetID]?.name ?? ""}`}
                        />
                    }
                    body={
                        <section
                        ...
                        >
                            <WidgetSettingsPreview
                                ...
                                value={value}
                                onChange={setValue}
                                schema={widgetCatalog[widgetID]?.schema ?? {}}
