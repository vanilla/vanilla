    ...
    return (
        <section className={classes.layout}>
            ...
            <div className={classes.textContainer}>
                <span className={classes.text}>{t("All clear!")}</span>
