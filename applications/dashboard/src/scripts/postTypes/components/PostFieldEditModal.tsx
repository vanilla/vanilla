...
export function PostFieldEditModal(props: IProps) {
    ...
    const isLinkedFieldDisabled = fieldSelectorValue.creationType === "linked" && !!fieldSelectorValue.linkedPostField;

    useEffect(() => {
        setShouldCreateApiLabel(!isLinkedFieldDisabled);
    ...
    useEffect(() => {
        ...
        if (fieldSelectorValue.creationType === "new") {
            setValues(null);
        }
    }, [fieldSelectorValue]);
    ...
    const schema = new SchemaFormBuilder()
        ...
        .textBox(
            ...
            !!props.postField || isLinkedFieldDisabled,
        )
        .required()
        .textArea(
            "description",
        ...
        .dropdown(
            ...
            formTypeAsOptions(postField?.formType),
            isGlobalDisabled,
        )
        .required()
        .textArea(
