...
describe("DefaultCategoriesModal", () => {
    ...
    it("renders empty table state", async () => {
        mockAdapter.onGet("/categories?outputFormat=flat").reply(200, []);
        renderInProvider([]);
    ...
    it("saved categories render in the table", async () => {
        mockAdapter
            .onGet("/categories?outputFormat=flat")
            .reply(200, CategoryPreferencesFixture.getMockCategoryResponse());
