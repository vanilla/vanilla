        ...
        return {
            ...
            contents: (
                <JsonSchemaForm
                    ...
                    FormGroupWrapper={NotificationPreferencesFormGroupWrapper}
...
const NotificationPreferencesFormGroupWrapper: React.ComponentType<
    React.PropsWithChildren<{ groupName?: string; header?: string; description?: string }>
> = function (props) {
    const classes = defaultNotificationPreferencesFormClasses();
