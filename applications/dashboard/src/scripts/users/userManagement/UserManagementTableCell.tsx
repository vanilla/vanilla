        ...
        case UserManagementColumnNames.FIRST_VISIT:
            return (
                <RegularCell
                    ...
                    component={
                        userData.dateInserted ? (
                            <DateTime
                                isSameYear={moment(userData.dateInserted).isSame(new Date(), "year")}
                                timestamp={userData.dateInserted || ""}
                            />
                        ) : (
                            <></>
                        )
        ...
        case UserManagementColumnNames.LAST_VISIT:
            return (
                <RegularCell
                    ...
                    wrappedVersion={wrappedVersion}
                    component={
                        userData.dateLastActive ? (
                            <DateTime
                                isSameYear={moment(userData.dateLastActive).isSame(new Date(), "year")}
                                timestamp={userData.dateLastActive || ""}
                            />
                        ) : (
                            <></>
                        )
                ...
                <div key={key}>
                    {!wrappedVersion && (
                        <Button
                            ...
                            onClick={() => {
                                updateQuery && updateQuery({ roleIDs: [role.roleID] });
                            }}
            ...
            case ProfileFieldDataType.DATE:
                content = userProfileFieldValue ? (
                    <DateTime
                        ...
                        timestamp={userProfileFieldValue ? formatDateStringIgnoringTimezone(userProfileFieldValue) : ""}
                    />
                ) : (
                    <></>
                );
