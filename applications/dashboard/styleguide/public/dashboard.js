...
/**
 * --------------------------------------------------------------------------
 * Bootstrap (v4.0.0-alpha.2): flyouts.js
 * Licensed under MIT (https://github.com/twbs/bootstrap/blob/master/LICENSE)
 * --------------------------------------------------------------------------
 */
...
var Dropdown = (function ($) {
  ...
  var Selector = {
    BACKDROP: '.flyouts-backdrop',
    DATA_TOGGLE: '[data-toggle="flyouts"]',
    FORM_CHILD: '.flyouts form',
    ROLE_MENU: '[role="menu"]',
...
/**
 * If a btn-group gets too long for the window width, this will transform it into a flyouts-filter.
 *
 * Selector: `.btn-group`
 *
...
var buttonGroup = function(element) {
    ...
    /**
     * Transforms a button group into a flyouts-filter.
     *
     * @param $buttonGroup
     */
    var transformButtonGroup = function(buttonGroup) {
        ...
        $(elem).prepend(
            ...
            'id="' + id + '" ' +
            'type="button" ' +
            'class="btn btn-secondary flyouts-toggle" ' +
            'data-toggle="flyouts" ' +
            'aria-haspopup="true" ' +
            'aria-expanded="false"' +
            '>' +
    ...
    /**
     * Generates an equivalent flyouts to the btn-group. Calculates widths to see whether we show the flyouts
...
(function($) {
    ...
    /**
     * Makes sure our dropdowns don't extend past the document height by making the flyouts drop up
     * if it gets too close to the bottom of the page. Note that the actual flyouts javascript
     * functionality is contained in ../vendors/bootstrap/flyouts.js This function just changes whether the
     * flyouts opens up or opens down.
     *
     * Selector: `.flyouts`
     *
     * @param element - The scope of the function.
    ...
    function dropDownInit(element) {
        $('.dropdown', element).each(function() {
            ...
            var menuHeight = $('.flyouts-menu', $dropdown).height();
            var toggleHeight = $('.flyouts-toggle', $dropdown).height();
    ...
    $(document).on('contentLoad', function(e) {
        ...
        dropInit(e.target); // navbar 'me' flyouts
