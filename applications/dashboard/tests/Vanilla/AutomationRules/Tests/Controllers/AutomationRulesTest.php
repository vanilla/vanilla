...
class AutomationRulesTest extends AbstractAPIv2Test
{
     ...
     * @return array[]
     */
    protected function getExpectedCatalogTriggerArray(): array
    {
     ...
     * @return array[]
     */
    protected function getExpectedCatalogActionArray(): array
    {
    ...
    /**
     * Test that the `automation-rules/action-by-type` endpoint returns metadata for a single action.
     *
     * @return void
     */
    public function testGetActionByType()
    {
        $this->runWithUser(function () {
            $response = $this->api()
                ->get("automation-rules/action-by-type", ["type" => "bumpDiscussionAction"])
                ->getBody();

            $this->getExpectedCatalogActionArray();
            $this->assertIsArray($response);
            $this->assertEquals($this->getExpectedCatalogActionArray()["bumpDiscussionAction"], $response);
        }, $this->adminID);
    }
