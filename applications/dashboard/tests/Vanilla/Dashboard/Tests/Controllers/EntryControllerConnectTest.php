...
class EntryControllerConnectTest extends SiteTestCase
{
     ...
     */
    public function testAutoConnectWithVerifiedTrue(): void
    {
        $this->config->set("Garden.Registration.AutoConnect", true);

        $importedUser = $this->insertDummyUser();
        $ssoUser = $this->dummyUser(["Email" => $importedUser["Email"], "Verified" => 1, "UniqueID" => __FUNCTION__]);
     ...
     */
    public function testAutoConnectWithFailedVerify(): void
    {
        $this->config->set("Garden.Registration.AutoConnect", true);

        $importedUser = $this->insertDummyUser();
        $ssoUser = $this->dummyUser(["Email" => $importedUser["Email"], "Verified" => 0, "UniqueID" => __FUNCTION__]);
