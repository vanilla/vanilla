...
if ($Session->IsValid()):
   ...
   echo '<div class="WhoIs">';
      ...
      echo '<div class="MeMenu">';
         ...
         echo '<span class="ToggleFlyout FlyoutNotifications" rel="/profile/notificationspopin">';
         ...
         if (Gdn::ApplicationManager()->CheckApplication('Conversations')) {
            ...
            echo '<span class="ToggleFlyout FlyoutConversations" rel="/messages/popin">';
         ...
         if (Gdn::ApplicationManager()->CheckApplication('Vanilla')) {
            echo '<span class="ToggleFlyout FlyoutBookmarks" rel="/discussions/bookmarkedpopin">';
         ...
         echo '<span class="ToggleFlyout FlyoutAccount">';
