...
<div class="Box ProfileBox">
   ...
   <ul class="PanelInfo">
      ...
      <li><span class="Aside"><span class="Count"><?php echo $CountInbox; ?></span></span><?php echo Anchor(T('Inbox'), '/messages/all'); ?></li>
      <?php } ?>
      <li><span class="Aside"><span class="Count"><?php echo $CountNotifications; ?></span></span><?php echo Anchor(T('Notifications'), '/profile/notifications'); ?></li>
