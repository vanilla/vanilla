...
<?php
echo heading($this->data('Title'), t('Add Auto Ban'), '/dashboard/settings/bans/add', 'btn btn-primary js-modal');
...
helpAsset(sprintf(t('About %s'), t('Auto Bans')), $help);
...
if (empty($this->data('Bans', []))) {
    $title = $this->data('EmptyMessageTitle', $this->data('EmptyMessage', t('No Auto Bans Found')));
    $body = $this->data('EmptyMessageBody', t('Use the button at the top of the page to create an Auto Ban.'));
