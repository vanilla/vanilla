...
<h1>
   <?php echo T('Manage Embed Themes'); ?>
</h1>

<div class="Info">
   <p class="P"><?php echo T('Embed themes allow you to change the look and feel of your forum when embedded..'); ?></p>
...
<?php if (count($this->Data('AvailableThemes', array()))): ?>
   ...
   <table class="browser-embed-themes SelectionGrid Themes">
      <tbody>
      ...
      <?php
         ...
         $EnabledPreviewUrl = $this->Data('EnabledTheme.EmbedScreenshotUrl', FALSE);
         ...
         foreach ($this->Data('AvailableThemes') as $ThemeName => $ThemeInfo):
            ...
            $PreviewUrl = GetValue('EmbedScreenshotUrl', $ThemeInfo, FALSE);
         ...
         <td class="themeblock <?php echo $ClassCurrentTheme; ?> <?php echo $ColClass; ?>">
            ...
            <div class="theme-right-column">
               ...
               <div class="Buttons">
                  <div class="theme-buttons">
                     <?php
                        echo Anchor(T('Apply'), 'dashboard/settings/embedthemes/'.$ThemeName.'/'.$Session->TransientKey(), 'SmallButton EnableAddon EnableTheme', array('target' => '_top'));
            ...
            <?php
               ...
               $OptionsDescription = sprintf(T('This theme has additional options.', 'This theme has additional options on the %s page.'),
                  Anchor(T('Embed Theme Options'), '/dashboard/settings/embedthemeoptions'));
