...
$desc = $hasCustomStyles
    ? t("This theme has customizable styles.", "You can choose from one of the different styles this theme offers. ")
    : "";
...
<section>
    ...
    <ul class="label-selector theme-styles">
        <?php foreach ($this->data("ThemeInfo.Options.Styles") as $Key => $Options) {
            ...
            if (
                $this->data("ThemeOptions.Styles.Key") == $Key ||
                (!$this->data("ThemeOptions.Styles.Key") && $Basename == "%s")
            ) {
                $Active = " active";
            }
            ...
            <div class="image-wrap">
                ...
                $Screenshot = safeGlob(
                    PATH_THEMES .
                        DS .
                        $this->data("ThemeFolder") .
                        DS .
                        "design" .
                        DS .
                        changeBasename("screenshot.*", $Basename),
                    ["gif", "jpg", "png"]
                );
                $Screenshot = array_merge(
                    $Screenshot,
                    safeGlob(
                        PATH_ADDONS_THEMES .
                            DS .
                ...
                <div class="overlay">
                    <div class="buttons">
                        <?php echo anchor(
                            t("Select"),
                            "?style=" . urlencode($Key),
                            "js-select-theme btn btn-overlay Hijack",
                            ["Key" => $Key]
                        ); ?>
                    </div>
                    <div class="selected">
            ...
            if (isset($Options["Description"])) {
                echo '<div class="description">', $Options["Description"], "</div>";
            }
            echo "</li>";
