                        ...
                        <div class="image-wrap">
                            ...
                            <div class="overlay">
                                <div class="label-selector-corner-link">
                                    <?php echo anchor(dashboardSymbol('expand', '', 'icon-16'), 'dashboard/settings/themeinfo/'.$ThemeName, 'js-modal', ['data-content' => ['cssClass' => 'modal-preview modal-md'], 'data-modal-type' => 'noheader']); ?>
                                </div>
                                <div class="buttons">
