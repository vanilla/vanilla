...
<table class="Label AltRows">
   ...
   <tbody>
      <tr class="Alt">
         <td>
            <h4><?php echo Anchor('Keep User Content', 'user/delete/'.$this->User->UserID.'/keep'); ?></h4>
            <?php echo T("Just delete the user record, and keep all of the user's content."); ?>
         </td>
      </tr>
      <tr>
         <td>
            <h4><?php echo Anchor('Erase User Content', 'user/delete/'.$this->User->UserID.'/wipe'); ?></h4>
      ...
      <tr class="Alt">
         <td>
            <h4><?php echo Anchor('Delete User Content', 'user/delete/'.$this->User->UserID.'/delete'); ?></h4>
