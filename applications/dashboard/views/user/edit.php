        ...
        <li class="form-group" role="presentation">
            <div class="input-wrap no-label">
                <?php echo $form->checkBox(
                    "Verified",
                    t("Verified Label", "Verified. Bypasses spam and pre-moderation filters."),
                    ["value" => "1"]
                ); ?>
            </div>
        </li>
        <?php // No need to ban a new user.
            ...
            <li class="form-group" role="presentation">
                ...
                <div class="input-wrap">
                    <?php echo $form->checkBoxList(
                        "RoleID",
                        array_flip($this->data("Roles")),
                        array_flip($this->data("UserRoles"))
                    ); ?>
                </div>
            </li>
        <?php endif;
                    ...
                    <div class="form-group">
                        <div class="buttons input-wrap no-label">
                            ...
                            echo anchor(t("Generate Password"), "#", "GeneratePassword btn btn-secondary", [
                                "data-length" => Gdn::config("Garden.Password.MinLength"),
                            ]);
                            echo anchor(t("Reveal Password"), "#", "RevealPassword btn btn-secondary", [
                                "data-hide-text" => t("Hide Password"),
                                "data-show-text" => t("Reveal Password"),
                            ]);
                            ?>
                        </div>
                    </div>
...
<!--           Add a new user's password-->
    ...
    if ($editing) {
        $userData = [
            ...
            "bypassSpam" => $editing["Verified"],
            "emailConfirmed" => $editing["Confirmed"],
            "banned" => $editing["Banned"],
            "rankID" => $editing["RankID"],
            "roles" => $this->data("UserRoles"),
            "private" => $editing["Attributes"]["Private"] ?? false,
