...
use Vanilla\Forum\Models\CategoryContentGroupProvider;
use Vanilla\Forum\Models\DiscussionContentGroupProvider;
...
use Vanilla\Layout\Asset\DiscussionListAsset;
...
class ForumContainerRules extends AddonContainerRules
{
    ...
    public function configureContainer(ContainerConfigurationInterface $container): void
    {
        ...
        // Content Groups.
        $container
            ->rule(ContentGroupModel::class)
            ->addCall("addContentGroupRecordProvider", [new Reference(DiscussionContentGroupProvider::class)])
            ->addCall("addContentGroupRecordProvider", [new Reference(CategoryContentGroupProvider::class)]);
    }
}
