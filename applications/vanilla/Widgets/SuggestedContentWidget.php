...
class SuggestedContentWidget implements ReactWidgetInterface, CombinedPropsWidgetInterface, ToggledWidgetInterface
{
    ...
    private static function commonSuggestedSchema(string $defaultTitle)
    {
        return Schema::parse([
            "enabled:b" => [
                "default" => true,
                "x-control" => SchemaForm::toggle(new FormOptions("Enabled")),
            ],
            "title:s" => [
                "default" => $defaultTitle,
                "x-control" => SchemaForm::textBox(new FormOptions("Title")),
            ],
            "subtitle:s?" => [
                "x-control" => SchemaForm::textBox(new FormOptions("Subtitle")),
            ],
            "limit:i" => [
                "minimum" => 0,
                "maximum" => 20,
    ...
    private static function suggestedFollowsSchema(): Schema
    {
        $schema = self::commonSuggestedSchema("Suggested Follows")
            ...
            ->setField("x-control", SchemaForm::section(new FormOptions("Suggested Follows")));
    ...
    private static function suggestedContentSchema(): Schema
    {
        $schema = self::commonSuggestedSchema("Suggested Content")
            ...
            ->setField("x-control", SchemaForm::section(new FormOptions("Suggested Content")));
        ...
        $propertiesSchema = Schema::parse([
            "excludedCategoryIDs?" => [
                ...
                "x-control" => SchemaForm::dropDown(
                    new FormOptions("Exclude Categories", "Select a category"),
                    new ApiFormChoices(
    ...
    public function getProps(): ?array
    {
        ...
        $this->props = array_merge($this->props, $suggestedContent);
