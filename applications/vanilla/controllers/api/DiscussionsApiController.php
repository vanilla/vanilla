...
class DiscussionsApiController extends AbstractApiController {
    ...
    public function delete_statuses(int $statusID): Data {
        ...
        $deleteEvent = new DiscussionStatusEvent(EventAction::DELETE, $statusID, $result, $this->getSession()->UserID);
    ...
    public function patch_statuses(int $statusID, array $body = []): Data {
        ...
        if (!empty($body)) {
            ...
            $updateEvent =
                new DiscussionStatusEvent(EventAction::UPDATE, $statusID, $result, $this->getSession()->UserID);
    ...
    public function post_statuses(array $body = []): Data {
        ...
        $insertEvent = new DiscussionStatusEvent(EventAction::ADD, $statusID, $result, $this->getSession()->UserID);
