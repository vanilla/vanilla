      ...
      if ($this->Form->IsPostBack() == FALSE) {
         ...
         if (!$Preview) {
            ...
            if (is_object($this->Category)) {
               ...
               if (!empty($this->Form->GetFormValue('Announce', '')) && !$Session->CheckPermission('Vanilla.Discussions.Announce', TRUE, 'Category', $this->Category->PermissionCategoryID))
                  $this->Form->AddError('You do not have permission to announce in this category', 'Announce');

               if (!empty($this->Form->GetFormValue('Close', '')) && !$Session->CheckPermission('Vanilla.Discussions.Close', TRUE, 'Category', $this->Category->PermissionCategoryID))
                  $this->Form->AddError('You do not have permission to close in this category', 'Close');

               if (!empty($this->Form->GetFormValue('Sink', '')) && !$Session->CheckPermission('Vanilla.Discussions.Sink', TRUE, 'Category', $this->Category->PermissionCategoryID))
