...
$Definition['%s deleted this conversation.'] = '%s はこの会話から削除されました。'; // applications/conversations/views/modules/inthisconversation.php
$Definition['Blank Message'] = '空のメッセージ'; // applications/conversations/views/messages/conversations.php
$Definition['Conversations Setup'] = '会話のセットアップ'; // applications/conversations/views/setup/index.php
$Definition['The user and all related content has been deleted.'] = 'このユーザーおよびすべての関連する内容は削除されました。'; // applications/conversations/settings/class.hooks.php
