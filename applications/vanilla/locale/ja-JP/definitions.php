...
$Definition['Activity.ActivityComment.FullHeadline'] = '%1$s が %4$s%8$sにレスしました。';
...
$Definition['Activity.DiscussionComment.FullHeadline'] = '%1$s が %4$s%8$sにレスしました。';
$Definition['Activity.DiscussionComment.ProfileHeadline'] = '%1$s が %4$s%8$sにレスしました。';
...
$Definition['Activity.RoleChange.FullHeadline'] = '%1$s が %4$s権限を変更しました。';
$Definition['Activity.RoleChange.ProfileHeadline'] = '%1$s が %4$s権限を変更しました。';
