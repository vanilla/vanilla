...
$Definition['conversation'] = 'プライベートメッセージ';
$Definition['Conversations'] = 'プライベートメッセージ (グループ) 数';
...
$Definition['Delete Conversation'] = 'この PM (グループ) を削除';
...
$Definition['Start a New Conversation'] = '新しい PM (グループ) を作成';
...
$Definition['The conversation has been cleared.'] = 'プライベートメッセージが削除されました。';
