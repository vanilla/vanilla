...
/**
 * Interface for ContentGroup Records.
 */
interface ContentGroupRecordProviderInterface
{
    /**
     * Get the record type handled by this content group.
     *
     * @return string
     */
    ...
    /**
     * Filter to recordIDs to ones that can be used in the content group.
     *
