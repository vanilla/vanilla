...
class VanillaEscalationAttachmentProvider implements AttachmentProviderInterface
{
    ...
    {
        return $this->session->getPermissions()->has("community.manage") ||
            $this->session->getPermissions()->has("posts.moderate");
    }
    ...
    {
        if ($this->session->checkPermission("community.manage")) {
            // Community managers can always view this.
            return true;
        }
