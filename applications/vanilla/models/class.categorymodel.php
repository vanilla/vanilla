    ...
    AggregateCountableInterface
{
    ...
    /**
     * Get all the visible categories for the site
     *
     * @return array
     */
    public function getPublicVisibleCategories(): array
    {
        return $this->modelCache->getCachedOrHydrate(
            ["publicVisibleCategories"],
            function () {
                return $this->createSql()
                    ...
                    ->where([
                        ...
                        "C.HideAllDiscussions" => 0,
                        "R.Type" => "guest",
                        "P.Vanilla.Discussions.View" => 1,
                    ])
                    ->get()
                    ->column("CategoryID");
            },
