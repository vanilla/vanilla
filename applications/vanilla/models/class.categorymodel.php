    ...
    AggregateCountableInterface
{
    ...
    {
        $postTypes = self::getPostTypeModel()->getAllowedPostTypesByCategory($category);
    ...
    public static function joinPostTypes(array &$categories): void
    {
        ...
        $postTypesByCategory = $postTypeModel->indexPostTypesByCategory($allowedPostTypes, "availableCategoryIDs");
