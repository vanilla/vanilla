    ...
    AggregateCountableInterface
{
    ...
    public function getWhereRecent($where = [], $limit = false, $offset = false, $expand = true)
    {
        ...
        $result = $this->getWhere($where, "DateLastComment", "desc", $limit, $offset, $expand);
        return $result;
    }
    ...
    public function getWhereQuery(
        ...
        if (isset($where["d.Type"]) && strtolower($where["d.Type"]) === "discussion") {
            if (!is_array($where["d.Type"])) {
                $where["d.Type"] = [$where["d.Type"]];
            }

            if (in_array("discussion", $where["d.Type"])) {
                $sql->beginWhereGroup()
                    ->where("d.Type", $where["d.Type"])
...
SQL;
    ...
    public function getAnnouncements($wheres = [], $offset = 0, $limit = false, $orderBy = null)
    {
        ...
        $data = $this->getWhere($whereAnnounce, $orderFields, $orderDirection, $limit, $offset);
        return $data;
    }
    ...
    public function getAnnouncementWhere(array $where, bool $includeAnnouncement = false)
    {
        ...
        if (isset($where["d.Announce"])) {
            ...
            $announce = $includeAnnouncement ? DiscussionModel::ANNOUNCEMENT : [false];
        } else {
