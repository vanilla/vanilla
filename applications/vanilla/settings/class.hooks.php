...
class VanillaHooks extends Gdn_Plugin
{
    ...
    public function discussionController_render_before($sender)
    {
        ...
        if (c("Plugins.Reactions.ShowUserReactions", ReactionModel::RECORD_REACTIONS_DEFAULT) == "avatars") {
    ...
    public function base_render_before($sender)
    {
        ...
        if (!isMobile()) {
            $sender->addDefinition(
                "ShowUserReactions",
                c("Plugins.Reactions.ShowUserReactions", ReactionModel::RECORD_REACTIONS_DEFAULT)
            );
        }
