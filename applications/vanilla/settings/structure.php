...
if ($Drop) {
   $SQL->Insert('Category', array('ParentCategoryID' => -1, 'TreeLeft' => 2, 'TreeRight' => 3, 'InsertUserID' => 1, 'UpdateUserID' => 1, 'DateInserted' => Gdn_Format::ToDateTime(), 'DateUpdated' => Gdn_Format::ToDateTime(), 'Name' => '‘‡', 'UrlCode' => 'general', 'Description' => '‘‡ƒXƒŒƒbƒh', 'PermissionCategoryID' => -1));
