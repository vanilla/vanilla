...
$Construct->dropIndexIfExists("Discussion", "IX_Discussion_QnA");
$Construct->dropIndexIfExists("Discussion", "IX_Discussion_DateInserted");
$Construct->dropIndexIfExists("Discussion", "IX_Discussion_DateLastComment");
$Construct->dropIndexIfExists("Discussion", "IX_Discussion_statusID");
$Construct->dropIndexIfExists("Discussion", "IX_Discussion_hot");
...
$Construct
    ->column("UserID", "int", false, ["primary", "index.UserID_Bookmarked", "index.UserID_Participated"])
    ...
    ->column("Participated", "tinyint(1)", "0", "index.UserID_Participated") // whether or not the user has participated in the discussion.
    ->set($Explicit, $Drop);
...
//Structure to hold content group
$Construct
    ->table("contentGroup")
    ->primaryKey("contentGroupID")
    ...
    ->set($Explicit, $Drop);
$Construct
    ->table("contentGroupRecord")
    ->column("contentGroupID", "int", false, "primary")
