...
describe("CategoryFollowDropDown", () => {
    ...
    it("unfollowed category displays the follow category button", async () => {
        ...
        const result = await renderInProvider();
        expect(await result.findByRole("button", { name: "Follow Category" })).toBeInTheDocument();
    });
    ...
    it("follow button saves category as followed", async () => {
        ...
        await renderInProvider({ emailDigestEnabled: false });
