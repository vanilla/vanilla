...
export const CategoryFollowDropDown = (props: IProps) => {
    ...
    const { userID, categoryID, emailDigestEnabled, preview, borderRadius, buttonColor, textColor, alignment } = props;
        ...
        <div className={classes.layout}>
            <DropDown
                ...
                buttonContents={
                    isFollowed ? (
                        <>
                            <Icon icon="me-notifications-solid" /> {t("Following")}
                        </>
                    ) : (
                        <>
                            <Icon icon="me-notifications" /> {t("Follow")}
                        </>
                    )
                }
