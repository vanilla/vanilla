...
export default function DeleteCommentsForm(props: IDeleteCommentsFormProps) {
    ...
    const [deleteMethod, setDeleteMethod] = useState<CommentDeleteMethod>(CommentDeleteMethod.FULL);
                        ...
                        <div className={classesFrameBody.contents}>
                            <>
                                ...
                                <InputBlock required label={t("Delete Method")}>
                                    <RadioPicker
                                        value={deleteMethod}
                                        onChange={(val: CommentDeleteMethod) => setDeleteMethod(val)}
                                        options={[
                                            {
                                            ...
                                            },
                                            {
                                                ...
                                                label: t("Full"),
                                                description: t(
                                                    "Completely remove the comment and all associated child comments.",
                                                ),
                                            },
                                        ]}
