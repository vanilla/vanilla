...
import { DraftStatus, DraftsSortValue, IDraft, ILegacyDraft } from "@vanilla/addon-vanilla/drafts/types";
...
export const DraftsApi = {
    ...
    schedule: async (apiParams: {
        draftID: RecordID;
        dateScheduled: string;
        publishedSilently?: boolean;
    }): Promise<void> => {
        await apiv2.patch(`/drafts/schedule/${apiParams.draftID}`, {
            dateScheduled: apiParams.dateScheduled,
            ...(apiParams.publishedSilently !== undefined && { publishedSilently: apiParams.publishedSilently }),
        });
    },
