...
import { DiscussionCommentEditorAssetPreview } from "@vanilla/addon-vanilla/thread/DiscussionCommentEditorAsset.preview";
...
registerWidgetOverviews({
    ...
    DiscussionCommentEditorAsset: DiscussionCommentEditorAssetPreview,
