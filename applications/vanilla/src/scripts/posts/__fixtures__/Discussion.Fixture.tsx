...
export class DiscussionFixture {
    ...
    public static CommentParentProvider = (props: { children: React.ReactNode }) => {
        return (
            <CommentThreadParentContext currentPage={1} {...this.mockCommentParent}>
                {props.children}
            </CommentThreadParentContext>
        );
    };
    ...
    public static PostPageProvider = (props: {
        ...
        return (
            <PostPageContextProvider
                initialPage={1}
                discussion={{ ...this.mockDiscussion, ...props.discussion }}
                discussionApiParams={{}}
            >
                {props.children}
            </PostPageContextProvider>
    ...
    public static mockCommentParent: ICommentParent = {
        recordType: "discussion",
        recordID: 10,
        url: this.mockDiscussion.url,
        categoryID: this.mockDiscussion.categoryID,
        dateInserted: this.mockDiscussion.dateInserted,
        insertUserID: this.commonFields.insertUserID,
    };
