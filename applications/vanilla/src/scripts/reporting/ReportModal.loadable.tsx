...
import type { IReportRecordProps } from "@vanilla/addon-vanilla/contentItem/ContentItemActions";
import { reportModalClasses } from "@vanilla/addon-vanilla/reporting/reportModal.classes";
...
export default function ReportModalLoadable(props: ReportModalProps) {
                ...
                body: (
                    <>
                        {escalateImmediately ? (
                            ...
                            <Translate
                                source={"Success! Your report has been submitted."}
    ...
    const handleHideFromCommunity = (isLegacyPage: boolean = false, recordType) => {
        ...
        if (recordType === "discussion") {
            if (props.onDiscussionPage || isLegacyPage) {
