...
describe("CommentThreadContext", () => {
    ...
    it("Adds a reply form", async () => {
        ...
        expect(result.current.currentReplyFormPath).toBe(firstComment.path);
    ...
    it("Switches reply form to a new ID", async () => {
        ...
        expect(result.current.currentReplyFormPath).not.toBe(firstComment.path);
        expect(result.current.currentReplyFormPath).toBe(secondComment.path);
