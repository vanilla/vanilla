...
import { CommentListSort } from "@vanilla/addon-vanilla/thread/CommentListSort";
...
export function useDiscussionThreadPager(
    pagingData: IWithPaging<any> | undefined,
    discussionBaseUrl: string,
    defaultSort: CommentListSortOption,
    sort: CommentListSortOption | undefined,
    page: number,
    onSortChange: (sort: CommentListSortOption) => void,
    ...
    const pagerProps: INumberedPagerProps = {
        ...
        onChange: (newPage) => {
            ...
            // Update the page URL.
            const discUrl = new URL(discussionBaseUrl);
