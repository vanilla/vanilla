...
import { DRAFT_CONTENT_KEY, DRAFT_PARENT_ID_KEY } from "@vanilla/addon-vanilla/thread/ThreadItemReply";
import { isThreadHole } from "@vanilla/addon-vanilla/thread/threadUtils";
import { t } from "@vanilla/i18n";
import { Icon } from "@vanilla/icons";
import { getLocalStorageOrDefault, useMeasure } from "@vanilla/react-utils";
    ...
    const commentThreadItemProps = {
        ...
        ...(props.threadItem.depth <= threadDepthLimit && {
            onReply: () => {
                ...
                const draftParentID = getLocalStorageOrDefault(
