...
import { IThreadItemReply } from "@vanilla/addon-vanilla/thread/@types/CommentThreadTypes";
import {
    DRAFT_CONTENT_KEY,
...
describe("ThreadItemReply", () => {
    ...
    it("Local storage cache is set up", async () => {
        ...
        expect(JSON.parse(localStorage.getItem(`vanilla//${DRAFT_PARENT_ID_AND_PATH_KEY}-10`) ?? "")).toStrictEqual({
            parentCommentID: 1,
            path: "1.2",
        });
    });
