...
facilisis luctus, metus</p>";
    ...
    /**
     * Test that the jsonLD data for an unknown discussion author.
     *
     * @return void
     */
    public function testUnknownUserStructuredDiscsusionData(): void
    {
        $user = $this->createUser();
        $this->runWithUser(function () {
            $this->createDiscussion();
        ...
        $this->discussionModel->setField($this->lastInsertedDiscussionID, "InsertUserID", 99999);
        ...
        $authorItem = $jsonLDItems[0]["author"];
