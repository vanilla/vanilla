...
class PostTypesTest extends AbstractAPIv2Test
{
    ...
    /**
     * This tests that when we associate categories with the post type, those categories are set to restricted.
     *
     * @return void
     */
    public function testCategoriesSetToRestrictedPostTypesWhenAssociatingCategories()
    {
        $category1 = $this->createCategory();
        $category2 = $this->createCategory();

        $this->testPost(["categoryIDs" => [$category1["categoryID"], $category2["categoryID"]]]);

        $this->assertApiResults(
            "/categories",
            ["categoryID" => [$category1["categoryID"], $category2["categoryID"]]],
            ["hasRestrictedPostTypes" => [true, true]]
        );
    }
}
