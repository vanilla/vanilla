    ...
    public function testDigestScheduling(): void
    {
        ...
        $this->runWithConfig(
            ...
            function () {
                ...
                // If we run again this digest will not be generated again.
                $this->assertDigestNotScheduled("it was already generated");
                $this->assertRecordsFound("digest", [], 1);

                // Even if we go right up to the hour we are no longer generating digests.
                CurrentTimeStamp::mockTime($oneMinuteBeforeStart->modify("+1 hour"));
                $this->assertDigestNotScheduled("it was already generated");
                $this->assertRecordsFound("digest", [], 1);
