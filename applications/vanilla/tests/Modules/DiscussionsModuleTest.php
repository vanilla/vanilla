...
class DiscussionsModuleTest extends StorybookGenerationTestCase {
    ...
    public function testUserNotFollowingCategory() {
        ...
        foreach ($this->categories as $category) {
            \Gdn::getContainer()->get(\CategoryModel::class)->follow($userID, $category['categoryID'], false);
        }
    ...
    public function testUserFollowingCategory() {
        ...
        \Gdn::getContainer()->get(\CategoryModel::class)->follow($userID, $followedCategoryID, true);
