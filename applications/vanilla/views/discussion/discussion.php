        ...
        <div class="Item-Header DiscussionHeader">
            ...
            <div class="AuthorWrap">
                ...
                <span class="AuthorInfo">
                    ...
                    if (
                        ...
                        echo wrapIf(htmlspecialchars(val("Title", $Author) ?? ""), "span", [
                            "class" => "MItem AuthorTitle",
                        ]);
                        echo wrapIf(htmlspecialchars(val("Location", $Author) ?? ""), "span", [
            ...
            <div class="Meta DiscussionMeta">
                <span class="MItem DateCreated">
                    <?php echo anchor(
                        Gdn_Format::date($Discussion->DateInserted, "html"),
                        $Discussion->Url,
                        "Permalink",
                        ["rel" => "nofollow"]
                    ); ?>
                </span>
                <?php echo dateUpdated($Discussion, ['<span class="MItem">', "</span>"]); ?>
                <?php
                // Include source if one was set
                if ($Source = val("Source", $Discussion)) {
                    echo " " .
                        wrap(sprintf(t("via %s"), t($Source . " Source", $Source)), "span", [
                            "class" => "MItem MItem-Source",
                        ]) .
                        " ";
                }
                // Category
                ...
                echo " " . t("in") . " ";
                echo anchor(
                    htmlspecialchars($this->data("Discussion.Category")),
                    categoryUrl($this->data("Discussion.CategoryUrlCode")),
        ...
        <div class="Item-BodyWrap">
            <div class="Item-Body">
                ...
                $this->fireEvent("AfterDiscussionBody");
                    $postMeta = getPostMeta($Discussion->DiscussionID);
                    echo TwigStaticRenderer::renderReactModule("legacyPostMeta", $postMeta ?? []);
