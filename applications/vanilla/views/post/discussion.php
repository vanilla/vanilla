...
<div id="DiscussionForm" class="FormTitleWrapper DiscussionForm">
    ...
    if ($this->ShowCategorySelector === true) {
        ...
        if (
            $this->Category &&
            $this->CategoryID > 0 &&
            $this->Category->DisplayAs === CategoryModel::DISPLAY_DISCUSSIONS
        ) {
        ...
        $options = [
            ...
            "AdditionalPermissions" => ["PermsDiscussionsAdd"],
        ];
    ...
    echo $this->Form->bodyBox("Body", [
        "Table" => "Discussion",
        "FileUpload" => Gdn::session()->checkPermission("Garden.Uploads.Add"),
    ...
    if (
        !property_exists($this, "Discussion") ||
        !is_object($this->Discussion) ||
        (property_exists($this, "Draft") && is_object($this->Draft))
    ) {
