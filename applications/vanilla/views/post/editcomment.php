    ...
    <div class="Form-BodyWrap">
        <div class="Form-Body">
            <div class="FormWrapper FormWrapper-Condensed">
                ...
                echo $this->Form->bodyBox('Body', ['Table' => 'Comment', 'FileUpload' => Gdn::session()->checkPermission('Garden.Uploads.Add'), 'placeholder' => t('Type your comment'), 'title' => t('Type your comment')]);
