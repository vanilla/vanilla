...
?>
    ...
    if (checkPermission("Garden.Settings.Manage")) {
        echo wrap(
            anchor(t("Don't use Categories"), "vanilla/settings/enablecategories?enabled=0", "SmallButton Hijack")
        );
    }
    ?></div>
<?php
...
$desc .=
    ...
    sprintf(
        t(
            "You can make the categories page your homepage.",
            'You can make your categories page your homepage <a href="%s">here</a>.'
        ),
        url("/dashboard/settings/homepage")
    ) .
    "</li>";
$desc .=
    "<li>" .
    sprintf(
        t(
            "Make sure you click View Page",
            'Make sure you click <a href="%s">View Page</a> to see what your categories page looks like after saving.'
        ),
        url("/categories")
    ) .
    "</li>";
...
?>
    ...
    echo '<div class="Info">' .
        ...
        wrap(
            sprintf(
                t(
                    ...
                    'Place nested categories in a comma-delimited list when they are %1$s'
                ),
        ...
        wrap(
            $this->Form->checkBox("Vanilla.Categories.HideModule", "Do not display the categories in the side panel."),
            "div"
        ) .
        "</div>" .
