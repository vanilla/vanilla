...
$dic->setInstance('Garden\Container\Container', $dic)
    ...
    ->addCall('addFormat', [\Vanilla\Quill\Formats\Link::class])
    ->addCall('addFormat', [\Vanilla\Quill\Formats\Bold::class])
    ->addCall('addFormat', [\Vanilla\Quill\Formats\Italic::class])
    ->addCall('addFormat', [\Vanilla\Quill\Formats\Code::class])
    ->addCall('addFormat', [\Vanilla\Quill\Formats\Strike::class])
