...
// This file is intentionally left as a cjs module so that tooling that requires cjs can use it synchronously.
...
module.exports = {
    getVanillaSrcDirs,
    getVanillaInjectables,
};

function getVanillaSrcDirs() {
...
function getVanillaInjectables() {
