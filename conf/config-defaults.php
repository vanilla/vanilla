...
$Configuration['Modules']['Dashboard']['Content'] = array('ProfileOptionsModule', 'UserBoxModule', 'UserPhotoModule', 'ProfileFilterModule', 'MessageModule', 'MeModule', 'Notices', 'ActivityFilterModule', 'ProfileFilterModule', 'Content', 'Ads');
...
$Configuration['Modules']['Vanilla']['Content'] = array('ProfileOptionsModule', 'UserBoxModule', 'UserPhotoModule', 'ProfileFilterModule', 'MessageModule', 'MeModule', 'UserBoxModule', 'NewDiscussionModule', 'Notices', 'NewConversationModule', 'NewDiscussionModule', 'DiscussionFilterModule', 'CategoryModeratorsModule', 'Content', 'Ads');
