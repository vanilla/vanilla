...
(function( window, undefined ) {
        ...
        for ( ; i < length; i++ ) {
            ...
            if ( (options = arguments[ i ]) != null ) {
                ...
                for ( name in options ) {
                    ...
                    /**
                     * PATCH NOTES: Resolve CVE-2019-11358
                     * Resolution: https://github.com/DanielRuf/snyk-js-jquery-174006/blob/master/jquery-1.12.4.patch
                     */
    ...
    jQuery.extend({
        ...
        /**
         * PATCH NOTE: We do not use global evaluation and it can be dangerous,
         * disabling this method altogether
         */
        ...
        while ( current ) {
            ...
            if ( current ) {
                ...
                // Convert response if prev dataType is non-auto and differs from current
                    ...
                    /**
                     * PATCH NOTE: Resolve CVE-2015-9251
                     * Issue: https://github.com/jquery/jquery/issues/2432
                     * Resolution: https://github.com/jquery/jquery/pull/2588/files
                     */
