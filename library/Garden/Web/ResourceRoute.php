...
class ResourceRoute extends Route
{
    ...
    public function match(RequestInterface $request)
    {
        ...
        $removeExtension =
            !empty($extension) && $request->getMethod() === "GET" && in_array($extension, self::viewsFormat);
        ...
        if ($removeExtension) {
            $result->setMeta("CONTENT_TYPE", "application/$extension; charset=utf-8");
        }
