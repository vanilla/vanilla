...
/**
 * A processor to run a callback whenever an insert operation is performed.
 */
class InsertProcessor implements Processor
{
    ...
    public function handle(Operation $operation, callable $stack)
    {
        return match ($operation->getType()) {
            Operation::TYPE_INSERT => call_user_func($this->onUpdate, $operation, $stack),
