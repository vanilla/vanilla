...
class LegacyEmbedReplacer
{
     ...
     *
     * Takes a url and tests to see if we can embed it in a post. If so, returns the embed code. Otherwise,
...
EOT;
                    ...
                    $result .=
                        '<span class="VideoPreview"><a href="https://www.youtube.com/watch?v=' .
                        $videoId .
                        $start .
                        '">';
                    $result .=
