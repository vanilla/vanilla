...
class FeatureService
{
     ...
     */
    private function addConfigFeature(string $featureID, string $configKey): void
    {
     ...
     * @return void
     */
    private function addFeatureFlagFeature(string $featureID, string $featureFlag): void
    {
