...
class Factory {
    ...
    /**
     * @var Container The container used to store the class information.
     */
    private $container;
    ...
    public function __construct(Container $container = null) {
        deprecated(self::class, Container::class);
     ...
     * @return boolean Whether or not a factory definition exists.
     */
     ...
     *
     * @return mixed Null of an instance of the requested class.
     */
     ...
     * </ul>
     *
     * @throws \Exception If an invalid factory type is provided.
     */
     ...
     * When an object with dependencies is created then the factory will call inline{@link Factory::factory()}
