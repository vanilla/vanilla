        ...
        $propertiesSchema = Schema::parse([
            ...
            "borderType:s?" => [
                ...
                "x-control" => SchemaForm::dropDown(
                    new FormOptions("Border Type", "Choose widget border type"),
    ...
    public static function viewAllSchema(string $description = null): Schema
    {
        $schema = Schema::parse([
            "position:s?" => [
                ...
                "x-control" => SchemaForm::dropDown(
                    new FormOptions("View All position", 'Choose "View All" link position.'),
                    new StaticFormChoices([
                        "top" => "Top",
                        "bottom" => "Bottom",
                    ])
            ...
            "to:s?" => [
                ...
                "x-control" => SchemaForm::textBox(
                    new FormOptions("View All URL", 'Set a custom url for "View All" link.')
                ),
            ],
            "name:s?" => [
                "description" => 'A custom name for the view all link. Default is "View All" or defined by the theme.',
                "x-control" => SchemaForm::textBox(
                    new FormOptions("View All link name", 'Set a custom name for "View All" link.')
                ),
            ],
        ]);
        if ($description) {
