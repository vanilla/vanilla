...
trait HomeWidgetContainerSchemaTrait
{
     ...
     * @return Schema
     */
    public static function widgetTitleSchema(string $placeholder = null, bool $required = false): Schema
    {
     ...
     * @return Schema
     */
    public static function widgetDescriptionSchema(string $placeholder = null, bool $required = false): Schema
    {
