 ...
 *
 * @deprecated Legacy widget factory for pockets. You probably want {@link ReactResolver} for custom layouts.
 */
class LegacyWidgetFactory implements \JsonSerializable
{
    use TwigRenderTrait;
    ...
    {
        if (is_a($this->widgetClass, LegacyWidgetModule::class, true)) {
