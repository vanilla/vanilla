...
trait FilterableWidgetTrait
{
    ...
    public static function filterTypeSchema(
        ...
        if ($hasFollowedFilter) {
            $fullSchema += self::followedFilterTypeSchema();
        }
     ...
     * @return array|array[]
     */
    private static function followedFilterTypeSchema(): array
    {
        $schema = [];
        ...
        $schema += [
            "followed?" => [
                ...
                "x-control" => SchemaForm::checkBox(
                    ...
                    new FieldMatchConditional(
                        "apiParams",
                        Schema::parse(["filter" => ["enum" => ["subcommunity", "category", "none"]]])
                    )
                ),
            ],
        ];
