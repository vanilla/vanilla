    ...
    public static function itemOptionsSchema(string $fieldName = 'itemOptions', array $allowedProperties = null): Schema {
        $schema = Schema::parse([
                ...
                'imagePlacementMobile:s?' => [
                    ...
                    'x-control' => SchemaForm::dropDown(
                        new FormOptions('Image Placement On Mobile', 'Describe the image placement in the widget item on smaller views.'),
                        new StaticFormChoices(['left' => 'Left', 'top' => 'Top'])
                    )
                ],
                'box?' => Schema::parse([
                    'borderType:s?' => [
                        ...
                        'x-control' => SchemaForm::dropDown(
                            new FormOptions(
                                'Border Type',
                                'Choose widget item border type.'
                            ),
                ...
                'contentType:s?' => [
                    ...
                    'x-control' => SchemaForm::dropDown(
                        new FormOptions(
                            'Content Type',
                            'Describe the widget item display style.'
                        ),
                        new StaticFormChoices(
                            [
                ...
                'display:?' => Schema::parse([
                    'name?' => [
                        ...
                        'x-control' => SchemaForm::toggle(
                            new FormOptions(
                                'Name',
                                'Whether to show widget item name.'
                            )
                        ),
                    ],
                    'description?' => [
                        ...
                        'x-control' => SchemaForm::toggle(
                            new FormOptions(
                                'Description',
                                'Whether to show widget item description.'
                            )
                        ),
                    ],
                    'counts?' => [
                        ...
                        'x-control' => SchemaForm::toggle(
                            new FormOptions(
                                'Counts',
                                'Whether to show widget item counts.'
                            )
                        ),
                    ],
                    'cta?' => [
                        ...
                        'x-control' => SchemaForm::toggle(
                            new FormOptions(
                                ...
                                'Whether to show widget item CTA.'
                            )
                        ),
                    ],
                ]),
                'alignment?' => [
                    ...
                    'x-control' => SchemaForm::dropDown(
                        new FormOptions(
                            'Content alignment',
                            'Describe the widget item content alignment.'
                        ),
                        new StaticFormChoices(
                            [
                                'center' => 'Center',
                ...
                'viewMore?' => Schema::parse([
                    'labelCode?' => [
                        ...
                        'x-control' => SchemaForm::textBox(new FormOptions('Label', 'Specify the "View More" button text/label.'))
                    ],
                    'buttonType:s?' => [
