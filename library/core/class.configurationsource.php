        ...
        switch ($this->Type) {
            case "file":
                if (empty($this->Source)) {
                    trigger_error(
                        errorMessage("You must specify a file path to be saved.", "Configuration", "Save"),
                        E_USER_ERROR
                    );
                }
                ...
                if ($fileContents === false) {
                    trigger_error(
                        errorMessage("Failed to define configuration file contents.", "Configuration", "Save"),
                        E_USER_ERROR
                    );
                }
                ...
                if (
                    $this->Configuration &&
                    $this->Configuration->caching() &&
                    Gdn::cache()->type() == Gdn_Cache::CACHE_TYPE_MEMORY &&
