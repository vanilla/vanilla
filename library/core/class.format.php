...
class Format {
   ...
   /**
    * Makes sure a string is formatted in the Latin1 character set.
    *
    * @param mixed $Mixed The data to format.
    * @return string The string in the Latin1 character set.
    */
   function Latin1($Mixed) {
      if(is_string($Mixed)) {
