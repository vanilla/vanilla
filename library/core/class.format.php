      ...
      if (!is_string($Mixed)) {
         ...
         if (is_null($Formatter)) {
            ...
            try {
               ...
               $Mixed2 = preg_replace("#\[quote=[\"']?([^\]]+)(;[\d]+)?[\"']?\](.*?)\[/quote\]#si",'<blockquote class="Quote" rel="\\1"><div class="QuoteAuthor">'.str_replace('%s', '\\1', T('%s said:')).'</div><div class="QuoteText">\\3</div></blockquote>',$Mixed2);
