 ...
 * 
 * This cache object makes use of the 'Memcache' PECL extension and requires 
...
class Gdn_Memcache extends Gdn_Cache {
   ...
   public function __construct() {
      ...
      if (!class_exists('Memcache')) {
         throw new Exception('PECL/Memcache was not found. See http://pecl.php.net/package/memcache');
      }
