    ...
    public function fetchViewLocation($view = '', $applicationFolder = '') {
        ...
        if (!$viewPath) {
            ...
            if ($themeFolder != '') {
                ...
                $viewPaths[] = combinePaths([PATH_ADDONS, $themeFolder, $applicationFolder, 'views', 'modules', $view.'.php']);
                ...
                $viewPaths[] = combinePaths([PATH_ADDONS, $themeFolder, 'views', 'modules', $view.'.php']);
            }
