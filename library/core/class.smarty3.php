...
class Gdn_Smarty {
   ...
   public function Render($Path, $Controller) {
      ...
      $SmartySecurity->secure_dir = array(dirname($Path));
      $SmartySecurity->php_functions = array_merge($SmartySecurity->php_functions,
   ...
   public function Smarty() {
      if(is_null($this->_Smarty)) {
         ...
         $Smarty->setCacheDir(PATH_CACHE . DS . 'Smarty' . DS . 'cache');
         $Smarty->setCompileDir(PATH_CACHE . DS . 'Smarty' . DS . 'compile');
         $Smarty->addPluginsDir(PATH_LIBRARY . DS . 'vendors' . DS . 'SmartyPlugins');
