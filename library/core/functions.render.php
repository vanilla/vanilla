        ...
        foreach($links as $i => $link) {
                if (val('separator', $link)) {
                    ...
                    if (val('active', $link)) {
                        ...
                        $output .= '  <a href="'.htmlspecialchars(val('url', $link)).'" role="menuitem" class="flyouts-menu-link selectBox-link" tabindex="0" aria-current="location">';
                        ...
                        $output .= '  <a href="'.htmlspecialchars(val('url', $link)).'" role="menuitem" class="flyouts-menu-link selectBox-link" tabindex="0" href="#">';
                        $output .=      val('name', $link);
                        $output .= '  </a>';
                        $output .= '</li>';
                    }
