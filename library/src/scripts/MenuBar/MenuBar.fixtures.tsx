...
export const TestMenuBarNestedWithInlineAndInputSubItems = function TestMenuBarNested(props: { autoOpen?: boolean }) {
    const withSubNavRef = useRef<IMenuBarContext>(null);
    ...
    const SubMenuItemRenderer = forwardRef((props, ref) => {
        return (
            <Row align="center" gap={4} justify="space-between" style={{ padding: 10 }}>
                <div>Input</div>
                <TextBox style={{ width: 100 }} ref={ref as Ref<HTMLInputElement>} />
            </Row>
        );
    }) as MenuBarSubMenuItem.SubMenuRenderer;

    SubMenuItemRenderer.displayName = "SubMenuItemRenderer";
    ...
    return (
        <MenuBar ref={withSubNavRef}>
            ...
            <MenuBarItem accessibleLabel="Item 1" icon={<ItalicIcon />}>
                ...
                <MenuBarSubMenuItemGroup hasInlineSubMenuItems groupTitle={"Group Title"}>
                    <MenuBarSubMenuItem isInline icon={<IndentIcon />} />
                    <MenuBarSubMenuItem isInline icon={<OutdentIcon />} />
                    <MenuBarSubMenuItem isInline icon={<IndentIcon />} />
                    <MenuBarSubMenuItem isInline icon={<OutdentIcon />} />
                </MenuBarSubMenuItemGroup>
                <MenuBarSubMenuItemGroup>
                    <MenuBarSubMenuItem subMenuItemRenderer={SubMenuItemRenderer} icon={<IndentIcon />} />
                </MenuBarSubMenuItemGroup>
            </MenuBarItem>
            <MenuBarItem accessibleLabel="Item 2" icon={<StrikeIcon />}>
                <MenuBarSubMenuItemGroup>
