...
export const bannerVariables = useThemeCache(styleOverwrite => {
    ...
    const outerBackground = makeThemeVars("outerBackground", {
        ...
        image: bannerFallbackBG,
        fallbackImage: bannerFallbackBG,
    });
...
export const bannerClasses = useThemeCache((styleOverwrite?: {}) => {
    ...
    const outerBackground = (url?: string) => {
        ...
        return style("outerBackground", {
            ...
            opacity: finalBackground.image === bannerFallbackBG ? 0.4 : undefined,
        });
    };
