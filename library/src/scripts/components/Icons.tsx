...
export function filePDF(className?: string) {
    ...
    return (
        ...
        >
            ...
            <rect width="18" height="18" rx="1" ry="1" fill="ff3934" />
            <polygon
                style={{ fill: "#fff" }}
                d="M5,16.767V8H6.884a2.808,2.808,0,0,1,.911.135,1.75,1.75,0,0,1,.714.481,1.881,1.881,0,0,1,.444.806,5.054,5.054,0,0,1,.123,1.25,6.209,6.209,0,0,1-.068,1,2.1,2.1,0,0,1-.289.764,1.843,1.843,0,0,1-.69.671,2.321,2.321,0,0,1-1.133.24h-.64v3.423ZM6.256,9.182v2.98h.6a1.279,1.279,0,0,0,.591-.111.7.7,0,0,0,.308-.308,1.114,1.114,0,0,0,.117-.455c.012-.181.019-.382.019-.6,0-.205,0-.4-.013-.585a1.259,1.259,0,0,0-.111-.486.7.7,0,0,0-.295-.32,1.169,1.169,0,0,0-.566-.111Zm3.755,7.585V8h1.86a2.161,2.161,0,0,1,1.644.591,2.341,2.341,0,0,1,.56,1.675v4.1a2.445,2.445,0,0,1-.6,1.816,2.356,2.356,0,0,1-1.718.585Zm1.256-7.585v6.4h.579a.93.93,0,0,0,.751-.265,1.278,1.278,0,0,0,.222-.831V10.266a1.325,1.325,0,0,0-.21-.8.892.892,0,0,0-.763-.283Zm3.99,7.585V8H19V9.182H16.513v2.66H18.68v1.182H16.513v3.743Z"
