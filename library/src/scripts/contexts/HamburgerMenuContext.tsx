...
interface IHamburgerMenuContext {
    ...
    addComponent: (componentConfig: PartialBy<IHamburgerDynamicComponent, "id">) => string;
...
export function HamburgerMenuContextProvider(props: { children: ReactNode }) {
    ...
    const updateComponent = (componentConfig: PartialBy<IHamburgerDynamicComponent, "id">): string => {
        ...
        return "Unable to update component";
    };

    /** Pass this function a componentConfig to have it render its content in the hamburger menu */
    const addComponent = (componentConfig: PartialBy<IHamburgerDynamicComponent, "id">): string => {
