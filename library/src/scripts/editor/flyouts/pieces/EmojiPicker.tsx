...
import { EMOJIS, EMOJI_GROUPS } from "@library/editor/flyouts/pieces/emojiData";
...
import { EmojiGroupButton } from "@library/editor/flyouts/pieces/EmojiGroupButton";
import EmojiButton from "@library/editor/flyouts/pieces/EmojiButton";
import Flyout from "@library/editor/flyouts/pieces/Flyout";
...
interface IProps extends IFlyoutToggleChildParameters {
    id: string;
    handleID: string;
    renderAbove?: boolean;
    renderLeft?: boolean;
...
export default class EmojiPicker extends React.PureComponent<IProps, IState> {
    ...
    constructor(props: IProps) {
        ...
        // this.categoryPickerID = "emojiPicker-categories-" + props.editorID; //fixme: there is no props.editorID
        this.categoryPickerID = "emojiPicker-categories-" + props.id;
    }
    ...
    private cellRenderer = ({ columnIndex, rowIndex, style }) => {
        ...
        return emojiData ? (
            <EmojiButton
                ...
                onClick={(event) => {
                    this.props.onInsertEmoji(emojiData.emoji);
