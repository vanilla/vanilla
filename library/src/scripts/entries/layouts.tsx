...
const isLayoutSubcommunityHomeEnabled = getMeta("featureFlags.layoutEditor.subcommunityHome.Enabled", false);
logDebug("Register homepage handler");
registerLayoutPage("/", () => {
    return {
        layoutViewType:
            isLayoutSubcommunityHomeEnabled && getSiteSection().sectionID !== "0" ? "subcommunityHome" : "home",
