...
import { IAnnounceDiscussionParams } from "@library/features/discussions/DiscussionActions";
...
function AnnounceDiscussionForm({ onCancel, onSuccess, discussion }: IProps) {
    ...
    return (
        <>
            ...
            <Modal isVisible={isVisible} size={ModalSizes.MEDIUM} exitHandler={close}>
                <AnnounceDiscussionForm discussion={discussion} onSuccess={close} onCancel={close} />
            </Modal>
        </>
    );
};
