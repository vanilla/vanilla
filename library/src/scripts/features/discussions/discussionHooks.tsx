...
import { logError, RecordID, stableObjectHash } from "@vanilla/utils";
...
export function useDiscussionByIDs(
    discussionIDs: Array<IGetDiscussionByID["discussionID"]>,
): IGetDiscussionByID | null {
    const { getDiscussionByIDs } = useDiscussionActions();

    // This state will handle the specific discussions requested
    const [discussions, setDiscussions] = useState<IGetDiscussionByID | null>(null);
