...
import { bulkMoveDiscussionFormClasses } from "@library/features/discussions/forms/BulkMoveDiscussionsForm.loadable.styles";
...
export default function BulkMoveDiscussionsForm(props: IBulkActionForm) {
    ...
    const classes = bulkMoveDiscussionFormClasses();
