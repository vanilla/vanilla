    ...
    return (
        <>
            ...
            {samePostType && sameCategory && (
                <div className={summaryClasses.noChanges}>
                    <span>
                        <Icon icon={"status-warning"} size={"compact"} /> Heads up!
                    </span>
                    <p>{t("It looks like you haven't made any changes yet.")}</p>
                    <p>{t("To update this post, go back and select a different post type or category.")}</p>
                </div>
            )}
        </>
    );
