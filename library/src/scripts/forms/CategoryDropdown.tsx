...
import { INestedLookupApi, INestedSelectOption, INestedSelectProps, NestedSelect } from "@library/forms/nestedSelect";
...
export function CategoryDropdown(_props: IProps) {
    ...
    const optionsLookup: INestedLookupApi = {
...
function getDefaultNestedOptions(initialOptions: INestedSelectOption[]): INestedSelectOption[] {
...
function getFilteredNestedOptions(initialOptions: INestedSelectOption[]): INestedSelectOption[] {
    const mapping: Record<string, INestedSelectOption> = {};
...
function transformChildren(option: INestedSelectOption): INestedSelectOption {
    return {
        ...option,
...
function getLabelFromKey(entry: [string, any]): INestedSelectOption {
