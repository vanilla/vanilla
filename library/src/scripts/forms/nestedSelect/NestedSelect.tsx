...
export function NestedSelect(props: INestedSelectProps) {
    ...
    const { options, optionsByValue, optionsByGroup } = useNestedOptions({
                ...
                <div className={classesInputBlock.inputWrap}>
                    <div
                        className={cx(classesInput.inputContainer, classes.inputContainer, classOverrides?.input, {
                            hasFocus: isFocused,
                            [classes.inputError]: Boolean(errors),
                        })}
                        onClick={() => {
                            if (inputRef.current) {
                                if (!isFocused && !isOpen) {
                    ...
                    >
                        <div className={classes.input}>
                            {multiple && (
                                <>
                                    {selectedTokens.map(({ label, value }, idx) => (
                                        <TokenItem
                                            key={idx}
                            ...
                            <input
                                ...
                                autoComplete="off"
                                ref={inputRef}
                                placeholder={multiple && selectedTokens.length ? undefined : props.placeholder}
                            />
                        </div>
