...
import { INestedSelectOption, INestedSelectOptionProps } from "@library/forms/nestedSelect/NestedSelect.types";

export const MOCK_SIMPLE_LIST: INestedSelectOption[] = [
...
export const MOCK_NESTED_LIST: INestedSelectOption[] = [
    { value: "", label: "None" },
...
export const MOCK_DEEP_NESTED_LIST: INestedSelectOption[] = [
    {
        label: "Fruit",
        value: "fruit",
        children: [
