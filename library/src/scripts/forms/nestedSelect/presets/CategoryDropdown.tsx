...
export function getDefaultNestedOptions(initialOptions: Select.Option[]): Select.Option[] {
...
export function getFilteredNestedOptions(initialOptions: Select.Option[]): Select.Option[] {
    const mapping: Record<string, Select.Option> = {};

    initialOptions.forEach((option) => {
        const breadcrumbs = option.data?.breadcrumbs ?? [];
