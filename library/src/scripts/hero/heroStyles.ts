...
export const heroVariables = useThemeCache(styleOverwrite => {
    const makeThemeVars = variableFactory("hero");
    ...
    const outerBackground = makeThemeVars("outerBackground", {
        ...
        image: heroFallbackBG,
        fallbackImage: heroFallbackBG,
    });
    ...
    // clean up and get rid of buttonTypeHero / searchButton
    ...
    const searchButton: any = makeThemeVars("heroSearchButton", {
...
export const heroClasses = useThemeCache(() => {
    ...
    const outerBackground = (url?: string) => {
        ...
        return style("outerBackground", {
            ...
            opacity: finalBackground.image === heroFallbackBG ? 0.4 : undefined,
        });
    };
