...
import { ISimpleBorderStyle, IFont, IBackground, IBoxOptions } from "@library/styles/cssUtilsTypes";
    ...
    (optionOverrides?: DeepPartial<IHomeWidgetItemOptions>, itemVars?: IThemeVariables) => {
        ...
        let options: IHomeWidgetItemOptions = makeVars(
            "options",
            {
                 ...
                 * @type string
                 * @enum title-description | title-description-image | title-description-icon | title-background
                 */
...
export const homeWidgetItemClasses = useThemeCache((optionOverrides?: DeepPartial<IHomeWidgetItemOptions>) => {
    ...
    const mobileQuery = layoutVariables().mediaQueries().oneColumnDown;
    ...
    const metas = style(
        ...
        vars.options.contentType === HomeWidgetItemContentType.TITLE_BACKGROUND && {
            "&&": {
