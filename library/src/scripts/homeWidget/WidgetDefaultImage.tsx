...
/**
 * Render a default image for a widget item. This is a dynamic SVG that will use the styleguide colors and applied if there is no specified fallback image or resource specific image.
 *
 * @public Exposed in the @vanilla/injectables/Components injectable.
 */
export function WidgetDefaultImage(props: { className?: string }) {
    ...
    return (
        <svg
            ...
            className={cx(homeWidgetItemClasses().defaultImageSVG, props.className)}
            aria-hidden="true"
        >
