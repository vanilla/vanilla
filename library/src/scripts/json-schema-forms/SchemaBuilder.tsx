...
export class SchemaFormBuilder {
    ...
    public textBoxInternal(property: string, label: string, description: string | null, type: ITextBoxControl["type"]) {
    ...
    public textBox(property: string, label: string, description: string | null) {
        return this.textBoxInternal(property, label, description, "text");
    }

    public textArea(property: string, label: string, description: string | null) {
        return this.textBoxInternal(property, label, description, "textarea");
    }

    public currency(property: string, label: string, description: string | null) {
        return this.textBoxInternal(property, label, description, "currency");
    }

    public ratio(property: string, label: string, description: string | null) {
        return this.textBoxInternal(property, label, description, "ratio");
    }

    public password(property: string, label: string, description: string | null) {
        return this.textBoxInternal(property, label, description, "password");
    }
