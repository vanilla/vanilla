...
//     ONE_COLUMN_NARROW = "one column narrow",
//     RIGHT_PANEL = "right panel",
//     FORUM_LAYOUT = "forum layout" // compatibility layout for old forum pages
// }
//
//
// const LayoutContext = React.createContext<LayoutTypes>(LayoutTypes.THREE_COLUMNS);
// const DeviceContext = React.createContext<Devices>();
