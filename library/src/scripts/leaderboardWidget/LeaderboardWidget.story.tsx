            ...
            <>
                <PermissionsFixtures.SpecificPermissions permissions={["profiles.view"]}>
                    <StoryContent>
                        ...
                        <StoryParagraph>
                            This widget displays a sorted list of users and their associated data. The default use case
                            for this widget is to display user points but can be extended to display other metrics or
                            multiple metrics by augmenting the data.
                        </StoryParagraph>
                    </StoryContent>
                    <WidgetLayout>
                        <SectionTwoColumns
