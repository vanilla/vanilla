...
import { BookmarkIcon, DropDownMenuIcon, GlobeIcon, NewPostMenuIcon } from "@library/icons/common";
...
export function StoryListItems(props: { as?: string; withTitles?: boolean }) {
    ...
    const actions = (
        <>
            <Button buttonType={ButtonTypes.ICON_COMPACT} className={iconClasses().bookmark()}>
                <BookmarkIcon />
            </Button>
