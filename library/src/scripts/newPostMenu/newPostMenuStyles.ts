...
export const newPostMenuClasses = useThemeCache((containerOptions?: DeepPartial<IHomeWidgetContainerOptions>) => {
    ...
    const dropdownWidth = forumLayoutVariables().panel.paddedWidth - globalVars.gutter.size;
