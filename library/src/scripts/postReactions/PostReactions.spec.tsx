...
import { IPostReaction, IPostRecord, PostReactionIconType } from "@library/postReactions/PostReactions.types";
import { PostReactionsContext } from "@library/postReactions/PostReactionsContext";
import { renderHook } from "@testing-library/react-hooks";
import { useToggleReaction } from "./PostReactions.hooks";
...
// Wrapper with QueryClientProvider for testing hooks
function renderComponent(props: { reactions?: IReaction[] } = {}) {
