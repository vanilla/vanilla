...
export function CategoryPreferencesTable(props: IProps) {
    const { onPreferenceChange, admin } = props;
    ...
    const digestEnabled = getMeta("emails.digest", false);
    ...
    useEffect(() => {
        setNotificationPreferenceTableVisibility(!digestEnabled || hasPreferences);
    }, [hasPreferences]);
    ...
    return (
        <div className={props.className}>
            ...
            <div className={cx({ [classes.inset]: digestEnabled })}>
