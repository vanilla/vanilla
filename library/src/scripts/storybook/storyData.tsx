...
export const STORY_IPSUM_LONG = blessStringAsSanitizedHtml(
    "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.",
);

export const STORY_IPSUM_LONG2 = blessStringAsSanitizedHtml(
...
export const STORY_IPSUM_LONG3 = blessStringAsSanitizedHtml(
...
export const STORY_IPSUM_MEDIUM = blessStringAsSanitizedHtml(STORY_IPSUM_LONG.slice(0, 160) + "…");

export const STORY_IPSUM_SHORT = blessStringAsSanitizedHtml(STORY_IPSUM_LONG.slice(0, 50) + "…");

export const STORY_DATE_STARTS = "2019-05-05T15:51:23.000Z";
export const STORY_DATE_ENDS = "2019-05-05T16:51:23.000Z";
...
export const STORY_COMMENT: IComment = {
    ...
    attributes: {},
    body: blessStringAsSanitizedHtml("This content is generated by users on the site. You can't update it here."),
...
export const STORY_COMMENTS: IComment[] = [
    {
        ...STORY_COMMENT,
        insertUser: {
            ...STORY_USER,
...
export const STORY_DISCUSSION: IDiscussion = {
