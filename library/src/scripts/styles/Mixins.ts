...
export class Mixins {
    ...
    public static box = (
        ...
        config?: { noPaddings?: boolean; onlyPaddings?: boolean },
    ): CSSObject => {
        ...
        if (hasFullOutline && !hasBackground && globalVars.options.preset === GlobalPreset.DARK) {
            background = {
                color: globalVars.mainColors.bg.lighten(0.05),
            };
        }
