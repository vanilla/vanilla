...
import { colorOut, offsetLightness } from "@library/styles/styleHelpersColors";
...
function calculateVars(props: IProps) {
    ...
    globalFg = offsetLightness(globalFg, 0.15) as ColorHelper;
    ...
    const splashBg = offsetLightness(globalPrimary, 0.2);
