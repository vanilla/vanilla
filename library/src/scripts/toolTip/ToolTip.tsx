...
function TriangleTooltip(props: { children: React.ReactNode; label: Element; ariaLabel?: Element }) {
    const globalVars = globalVariables();
 ...
 */
export function ToolTip(props: { children: React.ReactNode; label: Element; ariaLabel?: Element }) {
    const { children, label, ariaLabel } = props;
