...
const DRAGGING_ITEM_PORTAL_ID = "dragging-item-portal";
...
function FormTreeContent<ItemDataType extends {}>(props: IProps<ItemDataType>) {
    const { value, onChange, RowContentsComponent, forceCompactDeleteAction, treeRowClassName } = props;
    ...
    const renderItem = (params: IRenderItemParams<ItemDataType>) => {
        const rendered = (
            <FormTreeRow<ItemDataType>
                ...
                forceCompactDeleteAction={forceCompactDeleteAction}
