...
export function UnsubscribePageImpl(props: IProps) {
                        ...
                        <>
                            ...
                            <p>
                                <Translate
                                    ...
                                    c0={(content) => (
                                        <SmartLink
                                            to={`/profile/preferences/${encodeURIComponent(currentUser?.name ?? "")}`}
                                        >
                                            {content}
                                        </SmartLink>
                                    )}
                                    ...
                                    c0={(content) => (
                                        <SmartLink
                                            to={`/profile/preferences${
                                                currentUser?.userID !== userFragment.userID
    ...
    const manageNotificationBtn = isEmpty(unsubscribeData) ? null : (
        <LinkAsButton
            to={`/profile/${unsubscribeData.isUnfollowCategory ? "followed-content" : "preferences"}${
                currentUser?.userID !== userFragment.userID ? "?accountConflict=true" : ""
            }`}
