...
import cleanWordListContent from "@library/vanilla-editor/utils/cleanWordListContent";
...
export default function insertDataCustom(editor: MyEditor, data: DataTransfer) {
    ...
    // handle anything else, most likely plain text or html
        ...
        if (html) {
            ...
            let htmlString = isDocX ? cleanDocx(html, rtf) : html;

            // Clean Word list formatting if present
            htmlString = cleanWordListContent(htmlString);
