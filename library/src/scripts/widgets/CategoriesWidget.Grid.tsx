...
import { groupCategoryItems } from "@library/widgets/CategoriesWidget.utils";
...
export function CategoriesWidgetGrid(props: ICategoriesWidgetProps) {
    ...
    const categoryDefaultOptions: CategoriesWidgetItem.Options = {
        ...categoryOptions,
    ...
    const classes = categoriesWidgetListClasses(categoryDefaultOptions, true);
...
interface ICategoryGroup {
    ...
    group: Omit<CategoriesWidgetItem.Item, "categoryID" | "to" | "counts">;
    isFirstItem?: boolean;
...
function CategoryGridItemsGroup(props: ICategoryGroup) {
    ...
    const classes = categoriesWidgetListClasses(options, true);
...
export default CategoriesWidgetGrid;
