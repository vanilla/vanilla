 ...
 */
export const categoriesWidgetListVariables = useThemeCache(
    (itemOptionsOverrides?: CategoriesWidgetItem.Options, asTile = false, forcedVars?: IThemeVariables) => {
        /**
                    ...
                    font: Variables.font(
                        asTile
                            ? {
                                  ...
                                  color:
                                      itemOptionsOverrides?.contentType === WidgetItemContentType.TitleBackground
