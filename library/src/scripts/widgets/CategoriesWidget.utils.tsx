...
export type CategoryGridItemsGroup = Pick<CategoriesWidgetItem.Item, "children" | "displayAs" | "depth">;
 ...
 */
export function groupCategoryItems(itemData: CategoriesWidgetItem.Item[]) {
    ...
    for (const item of itemData) {
        if (item.displayAs !== "heading") {
            ...
            if (item.children && item.children.length > 0) {
                item.children = groupCategoryItems(item.children) as CategoriesWidgetItem.Item[];
            }
