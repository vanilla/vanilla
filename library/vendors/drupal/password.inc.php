<?php
/**
 * This file is included from Drupal with slight modifications.
 * The original can be found here: https://github.com/drupal/drupal/blob/7.x/includes/password.inc
 *
 * @copyright Copyright 2001 - 2013 by the original authors.
...
function _password_generate_salt($count_log2) {
   ...
   $output .= _password_base64_encode(openssl_random_pseudo_bytes(6), 6);
   return $output;
}
