...
class FlaggingPlugin extends Gdn_Plugin
{
    ...
    {
        $flaggedItemsResult = Gdn::sql()
            ->select("count(distinct(ForeignURL)) as NumFlaggedItems")
            ->from("Flag fl")
            ->get()
    ...
    public function controller_index($sender)
    {
        ...
        $configurationModel->setField(["Plugins.Flagging.UseDiscussions", "Plugins.Flagging.CategoryID"]);
    ...
    public function controller_dismiss($sender)
    {
        ...
        if (Gdn::session()->checkPermission("Garden.Moderation.Manage")) {
            ...
            [$controller, $encodedURL] = $arguments;
    ...
    public function discussionController_flag_create($sender)
    {
        ...
        [$context, $elementID, $elementAuthorID, $elementAuthor] = $arguments;
        ...
        if ($sender->Form->authenticatedPostBack()) {
            ...
            if (!$flagResult) {
                ...
                $subject = isset($prefixedDiscussionName)
                    ? $prefixedDiscussionName
                    : t("FlagDiscussion", "A discussion was flagged");
