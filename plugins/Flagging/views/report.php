...
printf('%s reported%s <strong>%s</strong>', Anchor($Flag['UserName'], '/profile/'.$Flag['UserID'].'/'.$Flag['UserName']), ($Flag['Context'] == 'comment') ? T(' a comment in') : null, Anchor($Report['DiscussionName'], $Flag['URL'])); 
