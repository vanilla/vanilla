...
class GettingStartedPlugin extends Gdn_Plugin
{
    ...
    public function settingsController_render_before($sender)
    {
        ...
        if (
            strcasecmp($sender->RequestMethod, "registration") == 0 &&
            $sender->Form->authenticatedPostBack() === true
        ) {
        ...
        if (strcasecmp($sender->RequestMethod, "index") == 0) {
            ...
            $welcomeMessage =
                ...
                '<ul>
        <li class="One' .
                (c("Plugins.GettingStarted.Dashboard", "0") == "1" ? " Done" : "") .
                '">
	    <strong>' .
        ...
        <li class="Two' .
                (c("Plugins.GettingStarted.Discussions", "0") == "1" ? " Done" : "") .
                '">
	    <strong>' .
        ...
        <li class="Three' .
                (c("Plugins.GettingStarted.Categories", "0") == "1" ? " Done" : "") .
                '">
        <strong>' .
                anchor(t("Organize your Categories"), "vanilla/settings/categories") .
                '</strong>
        <p>' .
                t(
        ...
        <li class="Four' .
                (c("Plugins.GettingStarted.Profile", "0") == "1" ? " Done" : "") .
                '">
        <strong>' .
        ...
        <li class="Five' .
                (c("Plugins.GettingStarted.Discussion", "0") == "1" ? " Done" : "") .
                '">
            <strong>' .
        ...
        <li class="Six' .
                (c("Plugins.GettingStarted.Plugins", "0") == "1" ? " Done" : "") .
                '">
        <strong>' .
                anchor(t("Manage Plugins"), "settings/plugins") .
                '</strong>
        <p>' .
                t(
