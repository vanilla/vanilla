...
*/    
   ...
   .'<ul>
      ...
      <li class="Two'.(C('Plugins.GettingStarted.Discussions', '0') == '1' ? ' Done' : '').'">
         ...
         <p>'.T('Access your community forum by clicking the "Visit Site" link on the top-left of this page, or by ').Anchor(T('clicking here'), '/').T('. The community forum is what all of your users &amp; customers will see when they visit ').T(Anchor(Gdn::Request()->Url('/', TRUE), Gdn::Request()->Url('/', TRUE))).'.</p>
      </li>
      <li class="Three'.(C('Plugins.GettingStarted.Categories', '0') == '1' ? ' Done' : '').'">
         <strong>'.Anchor(T('Organize your Categories'), 'vanilla/settings/managecategories').'</strong> <p>'.T('Discussion categories are used to help your users organize their discussions in a way that is meaningful for your community.').'</p>
      </li>
