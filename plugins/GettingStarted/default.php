...
*/    
   ...
   .'<ul>
      <li class="One'.(C('Plugins.GettingStarted.Dashboard', '0') == '1' ? ' Done' : '').'">
         ...
         <p>'.T('This is the administrative dashboard for your new community. Check
      ...
      <li class="Two'.(C('Plugins.GettingStarted.Discussions', '0') == '1' ? ' Done' : '').'">
         ...
         top-left of this page, or by ').Anchor(T('clicking here'), '/').T('. The
         community forum is what all of your users &amp; customers will see when
         they visit ').T(Anchor(Gdn::Request()->Url('/', TRUE), Gdn::Request()->Url('/', TRUE))).'.</p>
      </li>
      <li class="Three'.(C('Plugins.GettingStarted.Categories', '0') == '1' ? ' Done' : '').'">
         ...
         <p>'.T('Discussion categories are used to help your users organize their
      ...
      <li class="Four'.(C('Plugins.GettingStarted.Profile', '0') == '1' ? ' Done' : '').'">
         ...
         <p>'.T('Everyone who signs up for your community gets a public profile page
         ...
         ').Anchor(T('customize your profile now'), 'profile').'.</p>
      </li>
      <li class="Five'.(C('Plugins.GettingStarted.Discussion', '0') == '1' ? ' Done' : '').'">
         ...
         <p>'.T('Get the ball rolling in your community by ')
         .Anchor(T('starting your first discussion'), 'post/discussion').T(' now.').'</p>
      </li>
      <li class="Six'.(C('Plugins.GettingStarted.Plugins', '0') == '1' ? ' Done' : '').'">
         <strong>'.Anchor(T('Manage your Plugins'), 'settings/plugins').'</strong>
         <p>'.T('Change the way your community works with plugins. We\'ve bundled
