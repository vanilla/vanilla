...
class ParticipatedPlugin extends Gdn_Plugin
{
    ...
    public function container_init(Container $dic)
    {
        $dic->rule(\Vanilla\Menu\CounterModel::class)->addCall("addProvider", [
            new Reference(\Vanilla\Participated\ParticipatedCounterProvider::class),
        ]);
    }
    ...
    public function base_afterDiscussionFilters_handler($sender)
    {
        ...
        $result = wrap(anchor(sprite("SpParticipated") . t("Participated"), "/discussions/participated"), "li", [
            "class" => $cssClass,
        ]);
        echo $result;
    }
