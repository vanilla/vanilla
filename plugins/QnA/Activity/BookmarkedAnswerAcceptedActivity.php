 ...
 */
class BookmarkedAnswerAcceptedActivity extends Activity
{
    /**
    ...
    {
        return "BookmarkedAnswerAccepted";
    }
    ...
    {
        return "Notify me when a bookmarked question receives an accepted answer";
    }
    ...
    {
        return '{ActivityUserID,You} accepted an answer on your bookmarked question: <a href="{Url,html}">{Data.Name,text}</a>';
    }
    ...
    {
        return "when a comment is chosen as an appropriate answer on your bookmarked questions";
    }
