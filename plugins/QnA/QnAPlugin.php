...
class QnAPlugin extends Gdn_Plugin implements LoggerAwareInterface, PsrEventHandlersInterface
{
    ...
    public function handleDiscussionStatusEvent(DiscussionStatusEvent $event): DiscussionStatusEvent
    {
        ...
        if ($type != "question") {
            ...
            switch ($statusID) {
                case RecordStatusModel::DISCUSSION_STATUS_ACCEPTED:
                    ...
                    break;
                case RecordStatusModel::DISCUSSION_STATUS_ANSWERED:
                    ...
                    break;
                case RecordStatusModel::DISCUSSION_STATUS_REJECTED:
                    $set["QnA"] = "Rejected";
                    $set["DateAccepted"] = null;
                    $set["DateOfAnswer"] = null;
                    break;
                case RecordStatusModel::DISCUSSION_STATUS_UNANSWERED:
                    $set["QnA"] = "Unanswered";
                    $set["DateAccepted"] = null;
                    $set["DateOfAnswer"] = null;
                    break;
    ...
    public function recalculateDiscussionQnA($discussion, bool $return = false): void
    {
        ...
        if ($acceptedComment) {
            $status = RecordStatusModel::DISCUSSION_STATUS_ACCEPTED;
        } else {
            ...
            if ($answeredComment) {
                $status = RecordStatusModel::DISCUSSION_STATUS_ANSWERED;
            } elseif ($countComments > 0) {
                $status = RecordStatusModel::DISCUSSION_STATUS_REJECTED;
            } else {
                $status = RecordStatusModel::DISCUSSION_STATUS_UNANSWERED;
            }
        }
