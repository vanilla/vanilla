...
class BookmarkedAnswerAcceptedNotificationTest extends SiteTestCase
{
    ...
    public function testBookmarkedAnswerAcceptedNotification(): void
    {
        ...
        // Now make sure they don't get a notification for accepted an answer to their question.
        $this->clearUserNotifications($questionAuthor);
        $this->acceptAnswerAsUser($answer, $questionAuthor);
        $this->assertUserHasNoNotifications($questionAuthor);
        ...
        $this->assertUserHasNotificationsLike($bookmarkUser1, [
            ...
            new ExpectedNotification(
                ...
                ["accepted an answer on your bookmarked question", $question["name"]],
    ...
    public function testNotificationPreferencesRespected(): void
    {
        ...
        $this->api()->patch("/notification-preferences/{$bookmarkUserDisabled["userID"]}", [
            ...
            "BookmarkedAnswerAccepted" => ["email" => false, "popup" => false],
            "MyQuestionAnswerAccepted" => ["email" => false, "popup" => false],
        ]);
    ...
    public function testPauseAndResumeBookmarkedAnswerAcceptedLongRunner(): void
    {
        ...
        $action = $answerModel->createAnswerAcceptedLongRunnerAction($answer["commentID"]);
    ...
    /**
     * Test notifications for if the authors own answer is accepted.
     *
     * @return void
     */
    public function testMyQuestionAnswerAccepted(): void
    {
        $questionAuthor = $this->createUser();
        $answerAuthor = $this->createUser([
        ...
        $this->runWithUser(function () use ($question) {
            $answer = $this->createAnswer([
                "discussionID" => $question["discussionID"],
        ...
        $this->assertUserHasNotificationsLike($questionAuthor, [
            ...
            new ExpectedNotification(
                MyQuestionAnswerAcceptedActivity::getActivityTypeID(),
                [$answerAuthor["name"], "accepted an answer on your question", $question["name"]],
                implode(", ", [
