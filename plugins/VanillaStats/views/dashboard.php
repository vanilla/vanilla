...
<div id="StatsToolbar" class="toolbar toolbar-stats">
    ...
    <div id="StatsNavigation" class="toolbar-stats-daterange">
        ...
        <div class="btn-group pager-wrap">
            <button disabled="disabled" id="StatsNavPrev" class="btn btn-secondary btn-icon-border"><?php echo dashboardSymbol('caret-left'); ?></button>
            <button disabled="disabled" id="StatsNavNext" class="btn btn-secondary btn-icon-border"><?php echo dashboardSymbol('caret-right'); ?></button>
