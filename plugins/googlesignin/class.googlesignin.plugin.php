    ...
    public function settingsEndpoint($sender, $args)
    {
        ...
        if (!$form->authenticatedPostBack()) {
            ...
            $sender->Form->validateRule(
                "AssociationKey",
                "ValidateRequired",
                t("You must provide a unique AccountID.")
            );
        ...
        $formFields = [
            "AssociationKey" => [
                "LabelCode" => "Client ID",
                "Description" => t("Unique ID of the authentication application."),
            ],
            "AssociationSecret" => [
                "LabelCode" => "Secret",
                "Description" => t("Secret provided by the authentication provider."),
            ],
        ];

        $formFields["IsDefault"] = [
            "LabelCode" => t("Make this connection your default signin method."),
            "Control" => "checkbox",
        ];
