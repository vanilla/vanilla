...
class PocketsTest extends AbstractResourceTest {
    ...
    public function __construct($name = null, array $data = [], $dataName = '') {
        ...
        $this->editFields = ['name', 'body', 'repeatType', 'page', 'sort', 'location', 'format', 'mobileType', 'isDashboard', 'isEmbeddable', 'isAd', 'enabled'];
        $this->patchFields = ['name', 'body', 'repeatType', 'page', 'sort', 'location', 'format', 'mobileType', 'isDashboard', 'isEmbeddable', 'isAd', 'enabled'];
    }
