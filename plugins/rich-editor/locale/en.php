...
$Definition['richEditor.description.inlineMenu'] = 'A inline formatting menu will show up when you select text. Hit tab to get into that menu.';
...
$Definition['richEditor.menu.strike'] = 'strike';
