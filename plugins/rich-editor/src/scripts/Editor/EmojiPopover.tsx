...
interface IProps extends IEditorContextProps {
    ...
    id: string;
    blurHandler(event: React.FocusEvent<any>);
...
export class EmojiPopover extends React.PureComponent<IProps, IState> {
    private emojiGroupLength = Object.values(emojiGroups).length;
