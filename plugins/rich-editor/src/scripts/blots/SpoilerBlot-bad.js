...
// export default class SpoilerContentsBlot extends Block {
//     constructor(domNode) {
//         super(domNode);
//         domNode.classList.add("spoiler-content");
//     }
// }
// SpoilerContentsBlot.blotName = 'spoiler-contents';
// SpoilerContentsBlot.tagName = 'div';
...
export default class SpoilerBlot extends Container {
    ...
    //     domNode.classList.add('isOpen'); // Always open on edit
    //
    //     console.log("spoiler node: ", domNode);
    //
    //     return domNode;
    // }
