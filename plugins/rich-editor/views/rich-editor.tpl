<div class="richEditor" aria-label="{t c="Type your message"}" data-id="{$editorData.editorID}" aria-describedby="{$editorData.editorDescriptionID}" role="textbox" aria-multiline="true">
    ...
    <div class="richEditor-frame InputBox">
        <div class="js-RichEditorMobileCheck"></div>
        ...
        <div class="richEditor-menu richEditor-embedBar">
            <div class="richEditor-embedBarMobileBorder InputBox-borderWidth InputBox-borderColor">
                <ul class="richEditor-menuItems" role="menubar" aria-label="{t c="Inline Level Formatting Menu"}">
                    ...
                    <li class="richEditor-menuItem" role="menuitem">
                        <button class="richEditor-button richEditor-embedButton richEditor-buttonUpload js-fakeFileUpload" type="button" aria-pressed="false">
                            <svg class="richEditorButton-icon" viewBox="0 0 24 24">
        ...
        <div class="js-RichEditorUnstickyEmbed"></div>
    </div>
</div>
