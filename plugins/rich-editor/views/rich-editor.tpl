<div class="richEditor isDisabled" aria-label="{t c="Type your message"}" data-id="{$editorData.editorID}"  data-uploadenabled="{$editorData.uploadEnabled}" aria-describedby="{$editorData.editorDescriptionID}" aria-multiline="true">
