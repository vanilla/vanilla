...
$embedOperations = '[
    {
        "insert": {
            "embed-image": {
                "url":
                    "https://images.pexels.com/photos/31459/pexels-photo.jpg?w=1260&h=750&dpr=2&auto=compress&cs=tinysrgb",
                "alt": "Some Alt Text"
            }
        }
    },
    ...
    { "attributes": { "header": 2 }, "insert": "\n" },
    {
        "insert": {
            "embed-video": {
                ...
                "width": 1858,
                "height": 1276,
                "simplifiedRatio": { "numerator": 638, "denominator": 929, "shorthand": "929:638" }
            }
        }
    },
    { "insert": "Internal Link Embed" },
    { "attributes": { "header": 2 }, "insert": "\n" },
    {
        "insert": {
            "embed-link": {
    ...
    { "insert": "External Link Embed With Image" },
    { "attributes": { "header": 2 }, "insert": "\n" },
    {
        "insert": {
            "embed-link": {
