...
class APIv0 extends HttpClient {
    ...
    public function install($title = '') {
        ...
        /*
         * Cleanup the "remote" config file generated by a previous "remote" installation.
         * Otherwise you can get a case where Gargen.Installed is set to true while doing the installation!
         */
        if (file_exists(getcwd().'/conf/config.php')) {
            unlink(getcwd().'/conf/config.php');
        }
