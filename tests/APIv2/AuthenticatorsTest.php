...
class AuthenticatorsTest extends AbstractAPIv2Test
{
    ...
    public function testPost(array $postData, string $exceptionClass = null, string $message = null): void
    {
        ...
        if ($exceptionClass === null) {
            ...
            $this->assertEquals("OAuth2", $apiResponseBody["type"]);
        }
    }
    ...
    public function providerTestPost()
    {
        $r = [
            ...
            "Invalid OAUTH2 information" => [
                ...
                "secret is required. attributes.associationKey is required. attributes.baseUrl is required.",
            ],
    ...
    public function testPatch()
    {
        ...
        $this->assertArraySubsetRecursive($patchData["attributes"], $updatedAttributes);
