...
class ConversationsTest extends AbstractAPIv2Test
{
    ...
    public function testGet()
    {
        ...
        $result = $this->api()->get("{$this->baseUrl}/{$postedConversation[$this->pk]}");
    ...
    public function testGetParticipants()
    {
        ...
        $result = $this->api()->get("{$this->baseUrl}/{$conversation[$this->pk]}/participants");
    ...
    public function testDeleteLeave()
    {
        ...
        $result = $this->api()->delete("{$this->baseUrl}/{$conversation[$this->pk]}/leave");
        ...
        $participantsResult = $this->api()->get("{$this->baseUrl}/{$conversation[$this->pk]}/participants", [
            "status" => "all",
        ]);
    ...
    public function testPostParticipants()
    {
        ...
        $result = $this->api()->post("{$this->baseUrl}/{$conversation[$this->pk]}/participants", $postData);
        ...
        $updatedConversation = $this->api()
            ->get("{$this->baseUrl}/{$conversation[$this->pk]}")
            ->getBody();
        $this->assertEquals(
