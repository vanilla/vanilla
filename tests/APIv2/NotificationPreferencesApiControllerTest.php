...
class NotificationPreferencesApiControllerTest extends AbstractAPIv2Test
{
    ...
    public function testGetDefaults(): void
    {
        ...
        foreach ($defaults as $key => $val) {
            $this->assertTrue(in_array($key, $this->activityService->getActivityTypeIDs()));
     ...
     * @return void
     */
    public function testPatchDefaultsInvalidActivityType(): void
    {
        $this->expectExceptionCode(404);
        $this->expectExceptionMessage("'Invalid' is not a valid activity type");
