...
class ProfileFieldsApiControllerTest extends AbstractResourceTest
{
    ...
    public function providePatchData(): array
    {
        return [
            ...
            [["dataType" => "text", "formType" => "text"], ["formType" => "dropdown"], false],
            ...
            [["dataType" => "number", "formType" => "number"], ["formType" => "dropdown"], false],
            ...
            [["visibility" => "public", "mutability" => "all"], ["required" => true], false],
            [["visibility" => "public", "mutability" => "restricted"], ["required" => true], true],
            [["visibility" => "public", "mutability" => "none"], ["required" => true], true],
            [["visibility" => "private", "mutability" => "all"], ["required" => true], false],
            [["visibility" => "private", "mutability" => "restricted"], ["required" => true], true],
            [["visibility" => "private", "mutability" => "none"], ["required" => true], true],
            [["visibility" => "internal", "mutability" => "all"], ["required" => true], true],
            [["visibility" => "internal", "mutability" => "restricted"], ["required" => true], true],
            [["visibility" => "internal", "mutability" => "none"], ["required" => true], true],
        ];
    }
    ...
    public function providePostData(): array
    {
        ...
        $tests["Missing required"] = [array_diff_key($record, ["required" => 1]), false];
