...
class UsersTest extends AbstractResourceTest
{
    ...
    public function providePatchAndGetUserProfileFieldsData(): array
    {
        return [
            ...
            ["date", "date", "2022-09-01T05:54:26.990Z", "2022-09-01T00:00:00+00:00"],
            ["number", "number", 42, 42],
            ["number", "number", "42", 42],
     ...
     */
    public function testGetUserProfileFieldsWithVisibility(string $visibility, array $permissions)
    {
        $user = $this->createUser();
