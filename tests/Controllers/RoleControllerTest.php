...
class RoleControllerTest extends SiteTestCase
{
    ...
    {
        self::disableFeature(AiConversationModel::RAG_SEARCH_FEATURE_FLAG);
        ...
        $res->assertCssSelectorNotExists("input[type='checkbox'][value='Garden.RagSearch.View']");

        // Enable the feature flags and they should appear.
        self::enableFeature(AiConversationModel::RAG_SEARCH_FEATURE_FLAG);
        ...
        $res->assertCssSelectorExists("input[type='checkbox'][value='Garden.RagSearch.View']");
    }
}
