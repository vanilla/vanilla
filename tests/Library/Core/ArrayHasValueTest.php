...
class ArrayHasValueTest extends TestCase
{
     ...
     * @param mixed $testValue Value to search for.
    ...
    {
        $r = [
            "doesHaveValueStr" => [["0" => "x", "1" => "y", "2" => "z"], "x", true],
            "doesHaveValueInt" => [["0" => 1, "1" => 2, "2" => 3], 1, true],
            "doesNotHaveValueStr" => [["0" => "x", "1" => "y", "2" => "z"], "b", false],
            "doesNotHaveValueInt" => [["0" => 1, "1" => 2, "2" => 3], 5, false],
            "hasValueNestedArray" => [["0" => "x", ["1" => "y", "2" => "z"]], "z", true],
            "doesNotHaveValueNestedArray" => [["0" => "x", ["1" => "y", "2" => "z"]], "b", false],
        ];
