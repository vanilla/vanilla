...
class OffsetLimitTest extends TestCase
{
    ...
    {
        $r = [
            "getPageFormat" => ["p2", "25", false, [25, 25]],
            "rangeQueryFormat" => ["2-20", "25", false, [1, 19]],
            "limitOffsetPairFormat" => ["5lim2", "2", false, [5, 2]],
            "justLimitFormat" => ["5", "2", false, [5, 2]],
            "negativeValues" => ["-5", "-5", false, [0, 50]],
            "linPattern" => ["5lin2", "2", false, [4, 2]],
        ];
