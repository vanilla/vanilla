...
class RendererTest extends FixtureRenderingTest {
    ...
    public function testRender(string $dirname) {
        list($input, $expectedOutput) = $this->getFixture($dirname);
    ...
    public function dataProvider() {
        return [
            ["/editor-rendering/inline-formatting"],
            ["/editor-rendering/paragraphs"],
            ["/editor-rendering/headings"],
            ["/editor-rendering/lists"],
            ["/editor-rendering/emoji"],
            ["/editor-rendering/blockquote"],
            ["/editor-rendering/spoiler"],
            ["/editor-rendering/codeBlock"],
            ["/editor-rendering/all"],
            ["/editor-rendering/all-blocks"],
        ];
    }
}
