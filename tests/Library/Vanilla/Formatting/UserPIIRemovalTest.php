...
class UserPIIRemovalTest extends SiteTestCase
{
                        ...
                        "insert" => [
                            "embed-external" => [
                                "data" => [
                                    ...
                                    "body" => "<p>test</p>",
                                    "bodyRaw" => '[{"insert":"test"},{"insert":"\\n"}]',
                                    "format" => "rich",
                                    "dateInserted" => "2022-06-02T16:20:56+00:00",
                                    "insertUser" => [
                                        "userID" => 2,
                                        "name" => "UserToAnonymize",
                                    ...
                                    "url" => "https://dev.vanilla.localhost/discussion/1/test",
                                    "embedType" => "quote",
                                    "name" => "test",
                                ],
                                "loaderData" => [
                                    "type" => "link",
                                    "link" => "https://dev.vanilla.localhost/discussion/1/test",
                                ],
                            ],
                        ],
                    ],
    ...
    {
        return preg_replace("/:[0-9]+/", "", getenv("TEST_BASEURL")) . "/userpiiremovaltest";
    }
}
