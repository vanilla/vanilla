...
class LayoutTranslationTest extends SiteTestCase
{
    ...
    public function testLayoutTranslation(): void
    {
        ...
        $translationExists = $this->translationPropertyModel->getTranslations([
            "recordID" => $layout["layoutID"],
            "recordType" => "layout",
            "tp.resource" => CommunityMachineTranslationModel::TRANSLATION_RESOURCE,
        ]);

        $this->assertCount(0, $translationExists);
    }
