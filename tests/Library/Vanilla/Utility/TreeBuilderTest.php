    ...
    public function testBuildTree() {
        ...
        $expected = [
            $this->resultItem('1', 1, null, [
                $this->resultItem('1.1', 2, 1, [
                    $this->resultItem('1.1.1', 3, 2),
                ]),
    ...
    public function testFlattenTree() {
        $input = [
            $this->resultItem('item1', 1, -1, [
                $this->resultItem('item1.1', 2, 1, [
                    $this->resultItem('item1.1.1', 4, 2),
                ]),
