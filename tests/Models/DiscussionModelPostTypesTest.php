...
use VanillaTests\Models\PostTypeDiscussionModelTestTrait;
...
/**
 * Some basic tests for the `DiscussionModel` with post types feature enabled.
 */
class DiscussionModelPostTypesTest extends SiteTestCase
{
    use ExpectExceptionTrait,
        PostTypeDiscussionModelTestTrait,
        EventSpyTestTrait,
