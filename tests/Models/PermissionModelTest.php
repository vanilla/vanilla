...
class PermissionModelTest extends SiteTestCase
{
    ...
    public function testRolesHavingSpecificPermission(): void
    {
        ...
        $actualRoleIDs = $this->permissionModel->getRolesHavingSpecificPermission("Garden.Email.View");
        $this->assertEqualsCanonicalizing($expectedRoleIds, $actualRoleIDs);

        $expectedRoleIds = [16];
        $actualRoleIDs = $this->permissionModel->getRolesHavingSpecificPermission("Garden.Settings.Manage");
