...
<section>
    ...
    <script>
        jQuery(document).ready(function($) {
            ...
            $('.theme-styles a').click(function() {
                $('.theme-styles .label-selector-item').removeClass('active');
                $(this).parents('.label-selector-item').addClass('active');
                var styleKey = $(this).attr('key');
                $('#Form_StyleKey').val(styleKey);
                return false;
            });
        });
    </script>
